// build_nrseed.mjs — clon de build_nrg-oil (cadena fcsmanos10) + tipo "lamina" (LaminaZoom con zoom a regiones y CTA portada+QR). Lee _v3/nrseed_plan.json y emite
//   src/_fed6/VideoEdit/Main_nrseed.tsx      (build real, con `startSec:` por cue → lo mide el gate)
//   src/_fed6/VideoEdit/avatar_nrseed.gen.ts (ventanas de avatar → tiempo VISIBLE del gate)
//   src/index_nrseed.tsx
...
const SLUG = "nrseed", COMP = "Nrseed", UP = "NRSEED", FPS = 30;
const COVER = "img/nrseed_cover.jpg", QR = "qr_nrseed.png", SITE = "docfederer.com/after-60";
...
if (sinCama.length) {
  ...
  console.error("   → corré: node scripts/gen_beds.mjs nrseed");
  process.exit(1);
}
