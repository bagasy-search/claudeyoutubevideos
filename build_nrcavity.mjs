// build_nrcavity.mjs — clon de build_nrg-oil (cadena fcsmanos10) + tipo "lamina" (LaminaZoom con zoom a regiones y CTA portada+QR). Lee _v3/nrcavity_plan.json y emite
//   src/_fed6/VideoEdit/Main_nrcavity.tsx      (build real, con `startSec:` por cue → lo mide el gate)
//   src/_fed6/VideoEdit/avatar_nrcavity.gen.ts (ventanas de avatar → tiempo VISIBLE del gate)
//   src/index_nrcavity.tsx
...
const SLUG = "nrcavity", COMP = "Nrcavity", UP = "NRCAVITY", FPS = 30;
const COVER = "img/nrcavity_cover.jpg", QR = "qr_nrcavity.png", SITE = "docfederer.com/after-60";
...
if (sinCama.length) {
  ...
  console.error("   → corré: node scripts/gen_beds.mjs nrcavity");
  process.exit(1);
}
