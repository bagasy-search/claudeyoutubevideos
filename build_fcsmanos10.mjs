// build_fcsmanos10.mjs — MONTAJE del video `fcscanas` (plan → cues + Main + index + assets list).
//   node gen_fcsmanos10_plan.mjs && node build_fcsmanos10.mjs
...
const SLUG = "fcsmanos10", COMP = "Fcsmanos10", UP = "FCSMANOS10", FPS = 30;
...
// ── COMPUERTA: cobertura 100 % + avatar cada ≤30 s + apertura con avatar
{
  ...
  if (peor / FPS > 32) { console.error("⛔ hay más de 30 s sin avatar"); process.exit(1); }
}
