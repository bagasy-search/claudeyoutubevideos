// build_nrtongue.mjs — clon de build_nrg-oil (cadena fcsmanos10) + tipo "lamina" (LaminaZoom con zoom a regiones y CTA portada+QR). Lee _v3/nrtongue_plan.json y emite
//   src/_fed6/VideoEdit/Main_nrtongue.tsx      (build real, con `startSec:` por cue → lo mide el gate)
//   src/_fed6/VideoEdit/avatar_nrtongue.gen.ts (ventanas de avatar → tiempo VISIBLE del gate)
//   src/index_nrtongue.tsx
...
const SLUG = "nrtongue", COMP = "Nrtongue", UP = "NRTONGUE", FPS = 30;
const COVER = "img/nrtongue_cover.jpg", QR = "qr_nrtongue.png", SITE = "docfederer.com/after-60";
...
if (sinCama.length) {
  ...
  console.error("   → corré: node scripts/gen_beds.mjs nrtongue");
  process.exit(1);
}
