// build_nrcollagen.mjs — clon de build_nrg-oil (cadena fcsmanos10) + tipo "lamina" (LaminaZoom con zoom a regiones y CTA portada+QR). Lee _v3/nrcollagen_plan.json y emite
//   src/_fed6/VideoEdit/Main_nrcollagen.tsx      (build real, con `startSec:` por cue → lo mide el gate)
//   src/_fed6/VideoEdit/avatar_nrcollagen.gen.ts (ventanas de avatar → tiempo VISIBLE del gate)
//   src/index_nrcollagen.tsx
...
const SLUG = "nrcollagen", COMP = "Nrcollagen", UP = "NRCOLLAGEN", FPS = 30;
const COVER = "img/nrcollagen_cover.jpg", QR = "qr_nrcollagen.png", SITE = "docfederer.com/firm-skin";
...
if (sinCama.length) {
  ...
  console.error("   → corré: node scripts/gen_beds.mjs nrcollagen");
  process.exit(1);
}
