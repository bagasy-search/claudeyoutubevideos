...
// ⛔ EL PRIMER BEAT TIENE QUE ARRANCAR EN 0. El primer momento empieza en el ms de su primera
//    palabra (acá 240 ms), asi que los frames 0..6 no tenian NINGUN plano debajo y se veia el
//    fondo de marca: 233 ms de arranque oscuro justo en el hook, que es lo que mas se mira.
//    Quedo anotado como pendiente en fedvet2 y nunca se arreglo. La cobertura empieza en el
//    frame 0, no "casi".
if (beats.length && beats[0].ms_in > 0) beats[0].ms_in = 0;
