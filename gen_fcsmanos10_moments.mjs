// gen_fcsmanos10_moments.mjs — parte el GUION en momentos y (si ya existe el mapa) los ANCLA al ms.
...
const ABRE = [
  ["Mira tu mano.", "HOOK_MANO"],
  ["Te voy a decir algo que me dicen mucho", "HOOK_FOTOS"],
  ["Hoy te voy a enseñar algo que te aplicas", "PROMESA"],
  ["Y aquí me detengo tantito", "VERDAD"],
  ["Y hay tres cosas que te voy a guardar", "RETENCION"],
  ["Déjame presentarme rapidito", "INTRO"],
  ["Bueno. Ahora déjame contarte de alguien", "CASO_HORTENSIA"],
  ["Primero déjame explicarte qué son esas manchas", "MECANISMO"],
  ["Y ahora la pregunta que casi nadie se hace", "POR_QUE_MANOS"],
  ["Y déjame decirte algo del carro", "CARRO"],
  ["Ahora, déjame hacerte una prueba", "PRUEBA_MUNECA"],
  ["Ahora sí. Déjame decirte qué pasa en esas diez noches", "DIEZ_NOCHES"],
  ["La receta tiene tres cosas", "RECETA_INTRO"],
  ["Empiezo por el té verde", "TE_VERDE"],
  ["Ahora la leche de soya", "SOYA"],
  ["Y la miel. La miel es la que amarra", "MIEL"],
  ["Y antes de darte el cómo", "OTROS_REMEDIOS"],
  ["Bueno. Ahora el cómo", "PREPARACION"],
  ["Paso cuatro, el de la compresa", "COMPRESA"],
  ["Paso cinco. Cuando ya se secó", "SELLO"],
  ["Porque todo esto, la receta de la noche", "PROTECTOR"],
  ["Y si vas a manejar", "GUANTES_DIA"],
  ["El primero de los tres. El paso de los guantes", "GUANTES_NOCHE"],
  ["Ahora déjame decirte qué esperar, noche por noche", "NOCHE_A_NOCHE"],
  ["Y aquí va la segunda cosa que te guardé", "HOJA_BLANCA"],
  ["Bueno. Y después de las diez noches", "DESPUES"],
  ["Ahora déjame hablarte del error", "ERROR_TALLAR"],
  ["Y hay una cosa peor todavía", "CLORO"],
  ["¿Te acuerdas de la cremita", "MERCURIO"],
  ["Ahora déjame ponerte los límites de verdad", "ALERTAS"],
  ["Ahora, los cuidados de la receta", "CUIDADOS"],
  ["Y ahora déjame contestarte las preguntas", "PREGUNTAS"],
  ["Déjame juntarte todo en tres pasos", "RESUMEN"],
  ["Ahora, déjame terminarte lo de doña Hortensia", "FINAL_HORTENSIA"],
  ["Si quieres tener todo esto ordenado", "CTA"],
  ["Y déjame pedirte un favor", "CIERRE"],
];
const secPorParrafo = [];
{
