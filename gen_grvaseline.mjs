...
{ phrase: "oils get you", kind: "bars", title: "How much of the water actually stays in", unit: "%", bars: [
  ...
  { phrase: "it lets gas through", kind: "blurexplainer", image: I("lam_seal_closed"), side: "right",
...
{ phrase: "it needed an enemy", kind: "mitoverdad", eyebrow: "What you were taught",
  ...
  { phrase: "the molecules are simply too big", kind: "blurexplainer", image: I("lam_molecule_pore"), side: "left",
...
{ phrase: "something is going on round your eyes", kind: "callout", figure: "“", eyebrow: "Night 10 — my sister, who never says it",
  ...
  { phrase: "because this stuff migrates", kind: "blurexplainer", image: I("lam_migration"), side: "right",
...
{ phrase: "the second is glycerin", kind: "blurexplainer", image: I("lam_layers_stack"), side: "left",
...
{ phrase: "put a good thick layer on", kind: "mitoverdad", eyebrow: "What everybody tells you",
  ...
  { phrase: "the first microscopically thin film", kind: "blurexplainer", image: I("lam_thin_vs_thick"), side: "right",
