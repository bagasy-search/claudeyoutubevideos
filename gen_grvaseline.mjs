...
{ phrase: "it needed an enemy", kind: "mitoverdad", mythLabel: "MYTH", truthLabel: "THE TRUTH", eyebrow: "What you were taught",
    myth: "It is crude oil. It suffocates your skin and clogs your pores.",
    truth: "What is sold in a chemist is refined to a pharmaceutical standard, three times over. The testing says it does not block a pore.",
  ...
  { phrase: "your doctor is not hiding this from you", kind: "quote",
    ...
    image: I("129") },   // PullQuote solo lee `quote` e `image`: `author` se ignoraba en silencio
...
{ phrase: "about a grain of rice", kind: "stat", eyebrow: "The amount, for BOTH eyes",
  ...
  { phrase: "night eight was the first morning", kind: "stat", eyebrow: "Night 8 — the first real change",
    ...
    { phrase: "they were still there", kind: "mitoverdad", mythLabel: "MYTH", truthLabel: "THE TRUTH", eyebrow: "What I am NOT going to tell you",
    myth: "My eyes looked ten years younger.",
    truth: "The lines were exactly where I left them. What changed was the surface — filled in, calm, and no longer struggling.",
...
{ phrase: "it will not grow your eyelashes", kind: "mitoverdad", mythLabel: "MYTH", truthLabel: "THE TRUTH", eyebrow: "Two places the answer is simply no",
    myth: "It grows your lashes and your eyebrows.",
    truth: "It cannot. There is nothing in it that could. It makes the ones you already have look darker and glossier while it sits on them. That is all.",
...
{ phrase: "put a good thick layer on", kind: "mitoverdad", mythLabel: "MYTH", truthLabel: "THE TRUTH", eyebrow: "What everybody tells you",
    myth: "Put a good thick layer on. Slather it. More is better.",
    truth: "A thick layer cannot seal better than a thin one. The seal is made by the first microscopically thin film that touches your skin.",
