// build_nrpurpura.mjs — clon de build_nrg-oil (cadena fcsmanos10) + tipo "lamina" (LaminaZoom con zoom a regiones y CTA portada+QR). Lee _v3/nrpurpura_plan.json y emite
//   src/_fed6/VideoEdit/Main_nrpurpura.tsx      (build real, con `startSec:` por cue → lo mide el gate)
//   src/_fed6/VideoEdit/avatar_nrpurpura.gen.ts (ventanas de avatar → tiempo VISIBLE del gate)
//   src/index_nrpurpura.tsx
...
const SLUG = "nrpurpura", COMP = "Nrpurpura", UP = "NRPURPURA", FPS = 30;
const COVER = "img/nrpurpura_cover.jpg", QR = "qr_nrpurpura.png", SITE = "docfederer.com/age-spots";
...
if (sinCama.length) {
  ...
  console.error("   → corré: node scripts/gen_beds.mjs nrpurpura");
  process.exit(1);
}
