...
for (const [frag, props] of [
  ["las medidas exactas te las dejo escritas en la descripción", { eyebrow: "AHÍ ABAJO, EN LA DESCRIPCIÓN", title: "Las medidas exactas de la compresa",
    sub: "Cuánto té, cuánta soya y cuánta miel, y cómo seguir después de las diez noches.", domain: DOM, qr: QR, showQr: true }],
  ["todo eso te lo dejé en la guía de manos y cuello", { eyebrow: "EN LA DESCRIPCIÓN", title: "La Guía de Manos y Cuello",
    sub: "Noche por noche, qué hacer si tu piel es sensible y las señales de alerta de la piel. Parte del método completo del Dr. Federer.", domain: DOM, qr: QR, showQr: true }],
]) {
  const k = buscar(frag);
