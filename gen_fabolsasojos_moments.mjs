// gen_fabolsasojos_moments.mjs — parte el GUION en momentos y (si ya existe el mapa) los ANCLA al ms.
...
const ABRE = [
  ["Si te despiertas con estas bolsas", "HOOK"],
  ["Primero, cómo saber cuál tienes", "PRUEBA"],
  ["Y ahora la rutina de la mañana", "RUTINA"],
  ["Esa es la base.", "LOOPS"],
  ["Déjame presentarme rapidito", "INTRO"],
  ["Ahora, ¿por qué salen estas bolsas?", "MEC_GRASA"],
  ["La otra, la de líquido", "MEC_LIQUIDO"],
  ["Y aquí va algo que mucha gente no sabe", "HERENCIA"],
  ["Y otra cosa, que se confunde", "OJERA"],
  ["¿Y por qué después de los sesenta", "EDAD"],
  ["Déjame contarte de alguien", "MARTA1"],
  ["Presten mucha atención a esta imagen", "LAMINA"],
  ["Y dicho sea de paso", "GUIA"],
  ["Bueno, ahora vamos al error del frío", "ERRORES"],
  ["Ahora, algo que me preguntan siempre", "DURACION"],
  ["Y un truco práctico", "ESTACION"],
  ["Ahora, lo de la noche anterior", "NOCHE_SAL"],
  ["La segunda cosa de la noche", "NOCHE_ALMOHADA"],
  ["La tercera: el alcohol", "NOCHE_ALCOHOL"],
  ["Y ahora, déjame corregirme", "AGUA"],
  ["Y ahora, ¿qué pasó con doña Marta?", "MARTA2"],
  ["Ahora, las recetas que circulan", "RECETAS"],
  ["Cuando explico esto en la consulta", "CTA2"],
  ["Y ahora la que me preocupa", "RICINO"],
  ["Otra que anda circulando", "HEMORROIDES"],
  ["Y las cremas carísimas", "CREMAS"],
  ["Ahora quiero hablarte de tres cosas", "EMPEORAN"],
  ["Y ya que estamos, tres hábitos", "HABITOS"],
  ["Y alguien preguntaba en un comentario", "SIN_BOLSAS"],
  ["Y ahora sí, la señal que te prometí", "ALARMA"],
  ["Bueno. Y ahora, ¿qué pasa con la bolsa de grasa?", "GRASA_PRO"],
  ["Y aquí quiero leerte algo", "CIRUJANO"],
  ["Déjame repasarte todo", "REPASO"],
  ["Déjame terminar con doña Marta", "FINAL"],
