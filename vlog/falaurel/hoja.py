...
S = sys.argv[1]; V = "D:/Proyectos/video2-wt/falaurel/vlog/falaurel/"
...
face = Image.open(plan["face_gpt"]).convert("RGB"); face.thumbnail((w, h)); im.paste(face, (0, 0)); d.text((5, 5), "FACE", fill="red")
...
out = f"D:/rtmp/fl_hoja_{S}.jpg"; im.save(out, quality=80); print(out)
