// build_nrcream81.mjs — clon de build_nrg-oil (cadena fcsmanos10) + tipo "lamina" (LaminaZoom con zoom a regiones y CTA portada+QR). Lee _v3/nrcream81_plan.json y emite
//   src/_fed6/VideoEdit/Main_nrcream81.tsx      (build real, con `startSec:` por cue → lo mide el gate)
//   src/_fed6/VideoEdit/avatar_nrcream81.gen.ts (ventanas de avatar → tiempo VISIBLE del gate)
//   src/index_nrcream81.tsx
...
const SLUG = "nrcream81", COMP = "Nrcream81", UP = "NRCREAM81", FPS = 30;
const COVER = "img/nrcream81_cover.jpg", QR = "qr_nrcream81.png", SITE = "docfederer.com/botox";
...
if (sinCama.length) {
  ...
  console.error("   → corré: node scripts/gen_beds.mjs nrcream81");
  process.exit(1);
}
