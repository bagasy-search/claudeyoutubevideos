// build_nrtinnitus.mjs — mismo motor que build_nrvaseneck (cadena fcsmanos10: avatar por ventanas + LaminaZoom + camas). Sólo cambian slug/portada/QR/landing.
...
const SLUG = "nrtinnitus", COMP = "Nrtinnitus", UP = "NRTINNITUS", FPS = 30;
const COVER = "img/nrtinnitus_cover.jpg", QR = "qr_nrtinnitus.png", SITE = "docfederer.com/after-60";
