...
const COMPS = [
  ...
  { frag: "that is my brother Ray", comp: "RayCta",
    props: { eyebrow: "WRITTEN WITH MY BROTHER RAY", title: "The Thousand Dollar Afternoon",
      sub: "The night a $150 call becomes $1,500 · three phone scripts for eleven at night · the letter that claims the insurance credit you are owed · what to cancel",
