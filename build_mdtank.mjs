// build_mdtank.mjs — "Dump HYDROGEN PEROXIDE into your Toilet and WATCH WHAT HAPPENS" (Mike Dalton, EN).
//
//   node build_mdtank.mjs
//
// Lee `_v3/mdtank_plan.json` (el DIRECTOR) y escribe:
//   src/VideoEdit/cues_mdtank.gen.tsx · src/VideoEdit/avatar_mdtank.gen.ts
//   src/VideoEdit/Main_mdtank.tsx     · src/index_mdtank.tsx
//
...
for (const b of beats) {
  if (b.tipo === "componente" && b.ms_out - b.ms_in < 900) {
    b.tipo = "clip"; b.clip = b.clip || "mdtank_h01_fizzwatch"; b.startFrom = 0; delete b.componente; delete b.props;
  }
}
...
const imports = [
  ...
  ...movs.map((m) => `import { ${m} } from "../mdtank/${m}";`),
