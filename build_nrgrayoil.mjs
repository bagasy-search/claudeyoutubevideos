// build_nrgrayoil.mjs — clon de la cadena fcsmanos10. Lee _v3/nrgrayoil_plan.json y emite
//   src/_fed6/VideoEdit/Main_nrgrayoil.tsx      (build real, con `startSec:` por cue → lo mide el gate)
//   src/_fed6/VideoEdit/avatar_nrgrayoil.gen.ts (ventanas de avatar → tiempo VISIBLE del gate)
//   src/index_nrgrayoil.tsx
...
const SLUG = "nrgrayoil", COMP = "Nrgrayoil", UP = "NRGRAYOIL", FPS = 30;
...
// El PiP de FedWhiteboard (src/nrgrayoil/WhiteboardScene.tsx) no vive en el plan: se suma a mano.
...
// vuelve negro PURO. Medido: fcsunaclavada entregado = 57 tramos, nrgrayoil = 119, TODOS en
...
if (sinCama.length) {
  ...
  console.error("   → corré: node scripts/gen_beds.mjs nrgrayoil");
  process.exit(1);
}
