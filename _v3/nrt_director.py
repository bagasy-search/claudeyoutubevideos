...
# ───────────────────────── MECANISMO (120–270 s) ─────────────────────────
C("So. Where does the ringing come from?", "ChapterTitle", {"number": "1", "title": "Where the ringing comes from", "sub": "it's not where most people think"})
...
C("That static... that's your tinnitus.", "KaraokePhrase", {"eyebrow": "Remember this", "phrase": "That static is your tinnitus."})
...
C("Okay. Let's do the sixty seconds.", "ChapterTitle", {"number": "2", "title": "The 60-second drum", "sub": "just your two hands"})
...
C("that's what we call residual inhibition.", "KaraokePhrase", {"eyebrow": "The science word", "phrase": "Residual inhibition."})
...
C("Okay. Let's put it all together,", "ChapterTitle", {"number": "3", "title": "Tonight, in five steps", "sub": "start before the light goes off"})
