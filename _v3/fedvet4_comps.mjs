...
/** sello con el número de la señal — listicle: uno en CADA ítem, arriba a la izquierda, overlay */
const sello = (frag, n, caption) => ({
  frag, comp: "StatBug", overlay: true,
  props: { value: String(n), unit: n === 1 ? "SEÑAL" : "SEÑAL", caption, series: "Federer Veterinario",
    tone: n === 8 ? "danger" : "brass" },
});
