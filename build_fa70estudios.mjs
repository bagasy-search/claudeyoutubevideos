// build_fa70estudios.mjs — MONTAJE del video `fa70estudios` (plan → cues + Main + index + assets list).
//   node gen_fa70estudios_plan.mjs && node build_fa70estudios.mjs
...
const SLUG = "fa70estudios", COMP = "Fa70estudios", UP = "FA70ESTUDIOS", FPS = 30;
