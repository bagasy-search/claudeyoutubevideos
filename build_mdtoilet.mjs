// build_mdtoilet.mjs — "Why Does THIS Keep Coming Back and How to KILL it" (canal Mike Dalton, EN).
//
//   node build_mdtoilet.mjs
//
// Lee `_v3/mdtoilet_plan.json` (el DIRECTOR) y escribe:
//   src/VideoEdit/cues_mdtoilet.gen.tsx · src/VideoEdit/avatar_mdtoilet.gen.ts
//   src/VideoEdit/Main_mdtoilet.tsx     · src/index_mdtoilet.tsx
//
...
const SLUG = "mdtoilet", COMP = "MdToilet";
...
for (const b of beats) {
  if (b.tipo === "componente" && b.ms_out - b.ms_in < 900) {
    b.tipo = "clip"; b.clip = b.clip || "mdtoilet_h01_handle"; b.startFrom = 0; delete b.componente; delete b.props;
  }
}
...
const imports = [
  ...
  ...movs.map((m) => `import { ${m} } from "../mdtoilet/${m}";`),
