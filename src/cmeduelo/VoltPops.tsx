// VoltPops.tsx — LOS MICRO-EFECTOS del video `cmeduelo`.
//
...
// directores de sección en `_v3/cmeduelo_moments.json`:
//
...
const icon = (n?: string | null) => (n ? `img/cmeduelo/cmed_ic_${n}.png` : null);
...
export const QrFloat: React.FC<{ e: Efecto; durationInFrames: number; qr?: string; portada?: string }> = ({
  e, durationInFrames: D, qr = "img/cmeduelo/cmed_qr.png", portada,
}) => {
  ...
  return (
    <AbsoluteFill style={{ opacity: alive }}>
      ...
      <WhiteRoom at={0} dur={10}>
        ...
        <Img src={staticFile("img/cmeduelo/cmed_ic_mapa.png")} style={{
        ...
        {/* la camionetita */}
        <Img src={staticFile("img/cmeduelo/cmed_ic_camioneta.png")} style={{
