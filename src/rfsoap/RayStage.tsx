// RayStage.tsx — ESCENARIO COMPARTIDO del canal "Dr. Emmett Rowe" (EN, salud 70+) — copia de roweshower.
//
...
/** La marca de esquina del canal Dr. Emmett Rowe: carpeta de expediente con cruz clínica (The Rowe Files) (mismo nombre de export). */
export const Keyring: React.FC<{ size?: number }> = ({ size = 34 }) => (
  <svg width={size} height={size} viewBox="0 0 40 40" style={{ overflow: "visible" }}>
    <path d="M4 11 h12 l4 4 h16 v19 a2 2 0 0 1 -2 2 H6 a2 2 0 0 1 -2 -2 z" fill="none" stroke={V.brass} strokeWidth="2.4" strokeLinejoin="round" />
    <path d="M20 21 v10 M15 26 h10" fill="none" stroke={V.brass} strokeWidth="2.6" strokeLinecap="round" />
  </svg>
);
