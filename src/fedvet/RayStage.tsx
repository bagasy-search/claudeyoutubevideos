...
// ── PALETA / TIPOGRAFÍA ──────────────────────────────────────────────────────────────────────
export const V = {
  ink0: "#0B1014",       // negro cálido del canal (fondo)
  ink1: "#121A20",
  ink2: "#18232B",
  brass: "#E8A317",      // ÁMBAR — el acento del canal (el amarillo de las miniaturas)
  brassSoft: "#FFD98A",  // ámbar suave — títulos, resaltados
  amber: "#FFD98A",
  danger: "#D62828",     // ROJO — SÓLO la señal de alarma / el síntoma
  dangerSoft: "#E4574B",
  white: "#F4EFE6",
  bone: "#CFC5B4",
  steel: "#4E7BB5",      // el azul del ambo del veterinario
  ok: "#4E9E63",         // verde de "esto está bien" (checks positivos)
};
...
export const StatBug: React.FC<{
  ...
  value = "", unit = "", caption = "", series = "Federer Veterinario", tone = "brass",
}) => {
  const frame = useCurrentFrame();
