 ...
 * Los beats salen de ./cues_valeriavaselina.gen (los genera build_valeriavaselina.mjs,
...
import {BEATS, TOTAL_FRAMES_VV, type Cue} from './cues_valeriavaselina.gen';

const AVATAR = staticFile('valeriavaselina_opt.mp4');
...
const AvatarLayer: React.FC<{cuts: number[]}> = ({cuts}) => {
  ...
  const dust = React.useMemo(() => makeMotes(7, 'vv-dust', 2, 5, 0.008, 0.02, 0.05, 0.12), []);
  return (
    <>
      <AbsoluteFill
        style={{
...
export const MainValeriaVaselina: React.FC = () => {
...
export default MainValeriaVaselina;
