// Main_valeriapresion.tsx — Doctora Valeria Alcazar · pastillas para la tension
 ...
 * Los beats salen de ./cues_valeriapresion.gen (los genera build_valeriavaselina.mjs,
...
import {BEATS, TOTAL_FRAMES_VP, AVATAR_END_F, type Cue} from './cues_valeriapresion.gen';

const AVATAR = staticFile('valeriapresion_opt.mp4');
...
const AvatarLayer: React.FC<{cuts: number[]}> = ({cuts}) => {
  ...
  const dust = React.useMemo(() => makeMotes(7, 'vp-dust', 2, 5, 0.008, 0.02, 0.05, 0.12), []);
  return (
    <>
      <AbsoluteFill
        style={{
...
export const MainValeriaPresion: React.FC = () => {
...
export const TOTAL_FRAMES = TOTAL_FRAMES_VP;
export default MainValeriaPresion;
