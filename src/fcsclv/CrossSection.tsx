...
export const CrossSection: React.FC<{
  ...
  title = "Por dentro, así funciona",
  caption = "Lo que no se ve desde afuera",
  labels = [
    { text: "Entre las costillas" },
    { text: "Debajo de la piel" },
    { text: "Lo que se palpa desde fuera" },
  ],
  bed,
}) => {
        ...
        <svg viewBox={`0 0 ${W} ${H}`} width="100%" height="100%" style={{ position: "absolute", inset: 0, overflow: "visible" }}>
          <defs>
            ...
            <linearGradient id="cs_safe" x1="0" y1="0" x2="0" y2="1">
              ...
              <stop offset="100%" stopColor="#1A2734" />
            </linearGradient>
          </defs>
