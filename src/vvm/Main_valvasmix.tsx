/**
 * Main_valvasmix — Doctora Valeria Alcázar · "El ALIMENTO de $1 que DISPARA su COLÁGENO"
 ...
 * Audio: UN <Audio> con el máster (Fish). Todo video va muteado. Beats en ./cues_valvasmix.gen.
 */
...
import {BEATS, TOTAL_FRAMES_VVM} from './cues_valvasmix.gen';
...
export const MainValVasmix: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{background: VAL.paper, overflow: 'hidden'}}>
      <Audio src={staticFile('vvm/valvasmix.m4a')} />
...
export const TOTAL_FRAMES = TOTAL_FRAMES_VVM;
export default MainValVasmix;
