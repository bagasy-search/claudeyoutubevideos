...
// ── CANAL "Dr. Federer — The Nightly Remedy" (EN) · nightwater60 ─────────────
// Audio = máster Fish (voz del canal). Avatar = InfiniteTalk/RunPod SÓLO en las ventanas visibles
// (reel `nightwater60_avatar.mp4`, recortado con trimBefore). Todo video por OffthreadVideo.
export const TOTAL_FRAMES_NIGHTWATER60 = TOTAL_FRAMES;
const AVATAR_REEL = "nw/nightwater60_avatar.mp4";
...
export const MainNightwater60: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#0E1D23" }}>
    <Audio src={staticFile("nw/nightwater60.m4a")} />
