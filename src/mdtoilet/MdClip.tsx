// MdClip.tsx — el plano de b-roll del video `mdtoilet`: un pedazo de los clips i2v de Mike
// (`public/broll/mdtoilet_h*.mp4`, 1280x704, 5,04 s) recortado a la duración que pide el beat.
//
...
export const MdClip: React.FC<{
  ...
  src: string;          // "broll/mdtoilet_h11_squirtrim.mp4"
