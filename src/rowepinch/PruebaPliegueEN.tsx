...
export const PruebaPliegueEN: React.FC<{
  ...
  leftSeconds = 0,
  rightSeconds = 3,
  verdict = "The springs got tired",
  leftCaption = "SNAPS BACK",
  rightCaption = "STILL UP",
  rightDoneCaption,
}) => {
    ...
    <AbsoluteFill style={{ backgroundColor: BG, fontFamily: INTER }}>
      ...
      <div style={{ position: "absolute", right: 300, top: DIAL_TOP }}>
        <Dial
          ...
          pulse={0}
          breathe={breathe}
          caption={rightDone ? (rightDoneCaption ?? rightCaption) : rightCaption}
        />
      </div>
