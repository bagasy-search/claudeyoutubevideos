...
import { Media } from "../_fed6/VideoEdit/components/Media";
...
export const SplitCompareEN: React.FC<FdSplitCompareProps> = ({
  durationInFrames,
  left,
  right,
  eyebrow,
      ...
      >
        ...
        {win && vp > 0.02 && (
          ...
          >
            ...
            <div style={{ fontSize: 24, fontWeight: 900, letterSpacing: 3, color: "#FFFFFF" }}>BETTER</div>
          </div>
        )}
