...
const Titular: React.FC<{
  ...
  return (
    <div style={{
      position: "absolute", left: 62, bottom: 66, maxWidth: 1020,
...
export const MovCierre: React.FC<{ acto: number; gFrame: number }> = ({ acto, gFrame }) => {
  ...
  const c686X = lerp(32, GAP_X[3], viaja);
  const c686Y = lerp(41, 60.6, viaja);
  const c686S = lerp(152, 66, viaja);
    ...
    <AbsoluteFill style={{ backgroundColor: V.ink0 }}>
      ...
      <Layers cam={cam}>
        ...
        <Plane z={110}>
          ...
          {g < 440 && <Cifra x={68} y={c852Y} size={c852S} value="85,2" unit="W" />}
          {duo > 0.01 && (
            <div style={{
