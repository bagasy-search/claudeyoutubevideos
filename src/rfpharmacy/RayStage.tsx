// RayStage.tsx — ESCENARIO COMPARTIDO del canal "The Rowe Files" (EN, piel 70+) — copia de roweshower rebrandeada.
//
...
/** La marca de esquina de THE ROWE FILES: carpeta de expediente con cruz clínica (mismo nombre de export). */
export const Keyring: React.FC<{ size?: number }> = ({ size = 34 }) => (
  <svg width={size} height={size} viewBox="0 0 40 40" style={{ overflow: "visible" }}>
    <path d="M4 11 h11 l3 4 h18 v19 a2 2 0 0 1 -2 2 H6 a2 2 0 0 1 -2 -2 z" fill="none" stroke={V.brass} strokeWidth="2.4" strokeLinejoin="round" />
    <path d="M20 20 v11 M14.5 25.5 h11" fill="none" stroke={V.brass} strokeWidth="2.6" strokeLinecap="round" />
  </svg>
);
