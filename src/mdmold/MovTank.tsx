// MovTank.tsx — MOVIMIENTO "EL TANQUE" · 1722 frames @30fps (57,4 s) · canal Mike Dalton (EN)
//
...
// TABLA DE HANDOFF
// ══════════════════════════════════════════════════════════════════════════════════════════════
// ACTO 1 · f0-410 · "LA ETIQUETA" (protagonista: la advertencia pegada adentro del tanque)
...
//
// ACTO 2 · f410-730 · "LA LETRA CHICA" (protagonista: el texto — el texto ES el objeto)
...
//
// ACTO 3 · f730-1100 · "LA PASTILLA AZUL" (protagonista: el disco azul disolviéndose)
...
//
// ACTO 4 · f1100-1460 · "EL PRECIO" (protagonista: la goma muerta → la gotera)
...
//
// ACTO 5 · f1460-1722 · "DEBAJO DEL BORDE" (protagonista: el canal oculto con los rim jets)
...
const GhostLabel: React.FC<{ f: number }> = ({ f }) => {
  ...
  return (
    <div style={{
      ...
      {/* "y nadie la leyó nunca" — se empaña */}
...
const Act4: React.FC<{ f: number }> = ({ f }) => (
  <div style={{ position: "absolute", inset: 0, transformStyle: "preserve-3d" }}>
    ...
    {/* "cada vez que hay una pastilla en ese tanque": tres pastillas caen y cada una pudre un poco más */}
