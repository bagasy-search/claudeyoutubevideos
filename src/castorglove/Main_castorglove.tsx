...
// ── CANAL "Dr. Federer — The Nightly Remedy" (EN) · castorglove ─────────────
// Audio = máster Fish (voz del canal). Avatar = InfiniteTalk/RunPod SÓLO en las ventanas visibles
// (reel `castorglove_avatar.mp4`, recortado con trimBefore). Todo video por OffthreadVideo.
export const TOTAL_FRAMES_CASTORGLOVE = TOTAL_FRAMES;
const AVATAR_REEL = "cog/castorglove_avatar.mp4";
...
export const MainCastorglove: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#0E1D23" }}>
    <Audio src={staticFile("cog/castorglove.m4a")} />
