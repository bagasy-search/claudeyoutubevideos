...
const PAPEL_F = "img/cmegenerador/cmeg_mv_papel1.jpg";
const GEN_V = "broll/cmegenerador/cmeg_mv_papel2.mp4";     // generador gris sobre la losa nueva
const GEN_F = "img/cmegenerador/cmeg_mv_papel2.jpg";
const DUSK_F = "img/cmegenerador/cmeg_mv_papel3.jpg";      // el generador al anochecer, luz de estado
const PINZA_F = "img/cmegenerador/cmeg_mv_papel4.jpg";     // la mano apoyando la pinza sobre el papel
const CASA_F = "img/cmegenerador/cmeg_mv_papel5.jpg";      // la casa al anochecer, ventanas encendidas
