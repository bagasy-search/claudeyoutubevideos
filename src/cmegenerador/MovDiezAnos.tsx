            ...
            <div style={{
              ...
              <Plane z={-40} style={{ transform: "translateZ(-40px)", transformStyle: "preserve-3d" }}>
                <div style={{
                  ...
                  <MediaCard
                    src="img/cmegenerador/cmeg_mv_diez1.jpg" kind="photo"
                  ...
                  <MediaCard
                    src="img/cmegenerador/cmeg_mv_diez5.jpg" kind="photo"
          ...
          <div style={{
            ...
            {g >= 548 && g < 1052 && (
              <>
                <Plane z={-400} style={{ transform: "translateZ(-400px)", transformStyle: "preserve-3d" }}>
                  <PhotoPlane
                    src="img/cmegenerador/cmeg_mv_diez3.jpg" kind="photo"
            ...
            {enActo4 && !enActo5 && (
              <>
                <Plane z={-400} style={{ transform: "translateZ(-400px)", transformStyle: "preserve-3d" }}>
                  <PhotoPlane
                    src="img/cmegenerador/cmeg_mv_diez4.jpg" kind="photo"
