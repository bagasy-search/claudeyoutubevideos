    ...
    <AbsoluteFill style={{ backgroundColor: V.ink0, overflow: "hidden" }}>
      ...
      <Layers cam={cam}>
        ...
        <Plane z={-680} style={{ transform: `translateZ(-680px) translate3d(${(nx * -0.16).toFixed(1)}px, 0px, 0px)` }}>
          <Rebase shift={shift}>
            <PhotoPlane src="img/cmegenerador/cmeg_mv_llav1.png" kind="photo" z={0} scale={1.52}
        ...
        <div style={{
          ...
          <Plane z={-60} style={{ transform: `translateZ(-60px) translate3d(${(nx * 0.1).toFixed(1)}px, 0px, 0px)` }}>
            <Rebase shift={shift}>
              {g >= 186 && g < 396 && (
                <MediaCard src="img/cmegenerador/cmeg_mv_llav1.png" kind="photo" w={306} h={196}
                  x={79} y={29} z={40} ry={-13} lit={0.86} litColor={keyCol} sheenAt={200}
                  label="ESTADO DE CARGA" opacity={win(g, 186, 396, 14, 16)} />
              )}
              {g >= 470 && g < 712 && (
                <MediaCard src="img/cmegenerador/cmeg_mv_llav3.png" kind="photo" w={334} h={214}
                  x={79} y={28} z={54} ry={-14} lit={0.9} litColor={warmCol} sheenAt={484}
                  label="ENCLAVAMIENTO" opacity={win(g, 470, 712, 14, 16)} />
              )}
              {g >= 1100 && g < 1296 && (
                <MediaCard src="img/cmegenerador/cmeg_mv_llav4.png" kind="photo" w={330} h={248}
        ...
        {g >= 1793 && (
          <Plane z={10}>
            ...
            <Rebase shift={shift}>
              ...
              {g >= 1852 && g < 1948 && (
                <MediaCard src="img/cmegenerador/cmeg_lam_equipoC.png" kind="photo"
              ...
              {g >= 1912 && (
                <MediaCard src="img/cmegenerador/cmeg_mv_llav3.png" kind="photo"
