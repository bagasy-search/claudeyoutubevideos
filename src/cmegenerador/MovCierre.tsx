...
//
// ═══════════════════════════════════════ LAS COSTURAS ═════════════════════════════════════════
// f336        frontera 1→2 : MATCH-SHAPE. El rectángulo de la mesa (1180×460, x50 y45, rot −1.4) se
//                            deforma en la hoja vertical (700×880, x36 y50, rot 2.0) entre f330 y f402,
...
const SRC_TOOLS = "img/cmegenerador/cmeg_mv_cier1.jpg";        // pinza + medidor de enchufe en la mesa
const SRC_CLAUDIO = "img/cmegenerador/cmeg_mv_cier2.jpg";      // Claudio con la hoja impresa en la mano
const SRC_LAM_60 = "img/cmegenerador/cmeg_lam_60b_medio.jpg";  // página real: los 60 aparatos
const SRC_LAM_14 = "img/cmegenerador/cmeg_lam_14acciones.jpg"; // página real: las 14 acciones
...
export const MovCierre: React.FC<{ acto: number; gFrame: number }> = ({ acto, gFrame }) => {
  ...
  const rH = interpolate(g, [330, 402], [460, 880], CLAMP);
  const rXb = interpolate(g, [330, 402], [50, 36], CLAMP);
  const rY = interpolate(g, [6, 56, 330, 402], [12, 45, 45, 50], { easing: EZ, ...CLAMP });
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: V.ink0, overflow: "hidden" }}>
      ...
      <Layers cam={base.transform + " " + camK}>
        ...
        <Plane z={150}>
          {g >= 40 && g < 330 && (
            <IconPng src={IC_PINZA} x={16} y={58} size={104} z={0}
          ...
          {g >= 900 && g < 1188 && (
            <IconPng src={IC_BILLETE} x={30} y={74} size={116} z={0}
        ...
        <Plane z={zText}>
          ...
          {g < 344 && (
            <>
              <Readout value="$30" label="LA PINZA" at={at(30)} x={27} y={15} size={104} color={V.volt} />
              <Readout value="$20" label="EL MEDIDOR DE ENCHUFE" at={at(86)} x={71} y={15} size={104} color={V.amber} />
              <div style={{ position: "absolute", left: 130, top: 736, width: 820, opacity: ez(g, 8, 40) }}>
                <Bed w={800}>
          ...
          {hojaViva && (
            <div style={{
              position: "absolute", left: `${56 + shift}%`, top: 300, width: 700,
          ...
          {g >= RAIL_IN && g < 1188 && (
            <>
              <div style={{
                position: "absolute", left: `${124 + shift}%`, top: 256, width: 700,
              ...
              <div style={{ position: "absolute", left: `${124 + shift}%`, top: 0, width: 700, height: "100%" }}>
          ...
          {g >= 1204 && g < A5 && (
            <>
              {g >= 1246 && (
                <Readout value="−$41" label="EL PRIMER MES" at={at(1252)} x={17} y={31} size={112} color={V.amber} />
              )}
              <div style={{ position: "absolute", left: 130, top: 752, width: 880, opacity: ez(g, 1204, 1240) }}>
                <Bed w={860}>
              ...
              {g >= 1566 && (
                <div style={{
                  position: "absolute", left: 130, top: 676, opacity: ez(g, 1566, 1596),
          ...
          {g >= A5 && (
            <div style={{
              position: "absolute", left: 130, top: 758, width: 880,
              transform: `translateY(${(10 * (1 - ez(g, A5, A5 + 10))).toFixed(2)}px)`,
            }}>
              <Bed w={860}>
