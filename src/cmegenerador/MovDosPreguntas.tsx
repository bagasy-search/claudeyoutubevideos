...
const FILAS: { n: string; v: string; ic: string; cap: string; at: number; y: number }[] = [
  { n: "REFRIGERADOR", v: "1,3", ic: "img/cmegenerador/cmeg_ic_termometro.png", cap: "img/cmegenerador/cmeg_mv_dosp3.jpg", at: 1296, y: 47.2 },
  { n: "CONGELADOR", v: "0,9", ic: "img/cmegenerador/cmeg_ic_congelador.png", cap: "img/cmegenerador/cmeg_mv_dosp1.jpg", at: 1324, y: 54.0 },
  { n: "INTERNET", v: "0,4", ic: "img/cmegenerador/cmeg_ic_nube.png", cap: "img/cmegenerador/cmeg_mv_dosp4.jpg", at: 1352, y: 60.8 },
  { n: "LUCES", v: "0,3", ic: "img/cmegenerador/cmeg_ic_foco.png", cap: "img/cmegenerador/cmeg_mv_dosp2.jpg", at: 1380, y: 67.6 },
  { n: "TELÉFONOS", v: "0,2", ic: "img/cmegenerador/cmeg_ic_telefono.png", cap: "img/cmegenerador/cmeg_mv_dosp3.jpg", at: 1408, y: 74.4 },
];
  ...
  return (
    <AbsoluteFill style={{ opacity: intro, backgroundColor: V.ink0 }}>
      ...
      <Layers cam={camT}>
        ...
        <Stage x={0} on={g < 452}>
          <Plane z={-380}>
            <PhotoPlane src="img/cmegenerador/cmeg_mv_dosp1.jpg" kind="photo" z={0} scale={1.26} dim={0.76} tint={V.volt} />
          </Plane>
          <Plane z={-262}>
            <AbsoluteFill style={{
              opacity: 0.22,
          ...
          <Plane z={72}>
            ...
            <MediaCard src="img/cmegenerador/cmeg_mv_dosp1.jpg" kind="photo"
        ...
        <Stage x={1920} on={g > 296 && g < 806}>
          <Plane z={-330}>
            <PhotoPlane src="img/cmegenerador/cmeg_mv_dosp2.jpg" kind="photo" z={0} scale={1.32} dim={0.80} tint={V.volt} />
          </Plane>
          <Plane z={-186}>
          ...
          <Plane z={140}>
            ...
            <MediaCard src="img/cmegenerador/cmeg_mv_dosp3.jpg" kind="photo"
        ...
        <Stage x={3840} on={g > 748}>
          <Plane z={-380}>
            <PhotoPlane src="img/cmegenerador/cmeg_mv_dosp3.jpg" kind="photo" z={0} scale={1.30}
          ...
          {g > 1230 && (
            <Plane z={148}>
              <MediaCard src="img/cmegenerador/cmeg_mv_dosp4.jpg" kind="photo"
