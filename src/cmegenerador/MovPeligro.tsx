    ...
    <AbsoluteFill style={{ backgroundColor: V.ink0, overflow: "hidden" }}>
      ...
      <Layers cam={camT}>
        ...
        {g >= 706 && g < 962 && (
          <Plane z={0}>
            <MediaCard
              src="img/cmegenerador/cmeg_lam_7conexiones.png" kind="photo"
        ...
        {g >= 1272 && g < 1452 && (
          <Plane z={-40} style={{ opacity: ip(g, [1272, 1312, 1408, 1444], [0, 1, 1, 0.35]) }}>
            <MediaCard
              src="img/cmegenerador/cmeg_mv_peli3.png" kind="photo"
        ...
        {g >= 1842 && (
          <Plane z={0}>
            <MediaCard
              src="img/cmegenerador/cmeg_lam_cablefusible.png" kind="photo"
        ...
        {g >= 1872 && (
          <Plane z={-20} style={{ opacity: ip(g, [1872, 1914, 2220], [0, 1, 1]) }}>
            <MediaCard
              src="img/cmegenerador/cmeg_mv_peli4.png" kind="photo"
