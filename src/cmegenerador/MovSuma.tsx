...
const ROWS: {
  ...
  { src: "img/cmegenerador/cmeg_mv_suma3.png",   kind: "photo", ic: "img/cmegenerador/cmeg_ic_foco.png",       label: "FOCOS LED",  w: 272, watts: 45 },
  { src: "broll/cmegenerador/cmeg_mv_suma3.mp4", kind: "video", ic: "img/cmegenerador/cmeg_ic_telefono.png",   label: "MÓDEM",      w: 288, watts: 18 },
  { src: "img/cmegenerador/cmeg_mv_suma1.png",   kind: "photo", ic: "img/cmegenerador/cmeg_ic_enchufe.png",    label: "TELEVISOR",  w: 296, watts: 95 },
  { src: "img/cmegenerador/cmeg_mv_suma3.png",   kind: "photo", ic: "img/cmegenerador/cmeg_ic_bateria.png",    label: "CARGADORES", w: 264, watts: 30 },
];
    ...
    <AbsoluteFill style={{ backgroundColor: V.ink0, overflow: "hidden" }}>
      ...
      <Layers cam={base.transform}>
        <AbsoluteFill style={{ transform: camK, transformStyle: "preserve-3d" }}>
          ...
          <PhotoPlane src="img/cmegenerador/cmeg_mv_suma4.png" kind="photo" z={-620} scale={1.24} dim={bgDim} tint={V.steel} />
