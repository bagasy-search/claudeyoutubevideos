        ...
        <Plane z={-180}>
          ...
          {batOp > 0.01 && (
            <div style={{ opacity: batOp }}>
              <MediaCard
                src="img/cmegenerador/cmeg_mv_tdia2.jpg" kind="photo"
          ...
          {a3bOn && (
            <AbsoluteFill style={{
              ...
              <MediaCard
                src="img/cmegenerador/cmeg_mv_tdia3.jpg" kind="photo"
        ...
        <Plane z={-20}>
          ...
          {panelOp > 0.01 && (
            <div style={{ opacity: panelOp }}>
              <MediaCard
                src="img/cmegenerador/cmeg_mv_tdia1.jpg" kind="photo"
