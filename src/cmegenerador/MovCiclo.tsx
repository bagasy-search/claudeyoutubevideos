...
const Ciclo: React.FC<{ g: number }> = ({ g }) => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: V.ink0, overflow: "hidden" }}>
      ...
      {g < 1227 && (
        <PhotoPlane src="img/cmegenerador/cmeg_mv_cicl4.jpg" kind="photo" z={0} scale={1.2} dim={dimBack} tint={V.amber} />
      )}
      {g >= 1224 && g < 1556 && (
        <PhotoPlane src="img/cmegenerador/cmeg_mv_cicl3.jpg" kind="photo" z={0} scale={1.26} dim={0.74} tint={V.torch} />
      )}
      ...
      <Layers cam={camT}>
        ...
        <Plane z={40}>
          ...
          {g > 244 && g < 800 && (
            <MediaCard
              src="img/cmegenerador/cmeg_mv_cicl2.jpg" kind="photo"
