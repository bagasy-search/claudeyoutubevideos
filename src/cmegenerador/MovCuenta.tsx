  ...
  return (
    <AbsoluteFill style={{ backgroundColor: V.ink0 }}>
      ...
      <Layers cam={cam}>
        ...
        {g < SEAM_OCC ? (
          <PhotoPlane
            src="img/cmegenerador/cmeg_mv_cuen1.jpg" kind="photo" z={-620} scale={1.32}
            dim={lerp(0.68, 0.86, ez(g, 60, 900))} tint={V.volt}
          />
        ) : (
          <PhotoPlane
            src="img/cmegenerador/cmeg_mv_cuen5.jpg" kind="photo" z={-620} scale={lerp(1.30, 1.16, ez(g, SEAM_OCC, 2040))}
          ...
          {c12Vive && (
            <>
              ...
              <div style={{ opacity: c2 * (1 - salidaC12) }}>
                <MediaCard
                  src="img/cmegenerador/cmeg_mv_cuen2.jpg" kind="photo"
        ...
        <Plane z={120}>
          ...
          {lamVive && (
            <div style={{ opacity: lamOp }}>
              <MediaCard
                src="img/cmegenerador/cmeg_lam_cuenta2anos.jpg" kind="photo"
