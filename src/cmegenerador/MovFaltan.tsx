...
//   img/cmegenerador/cmeg_mv_falt1.jpg · broll/cmegenerador/cmeg_mv_falt1.mp4  (aire acondicionado)
//   img/cmegenerador/cmeg_mv_falt2.jpg · broll/cmegenerador/cmeg_mv_falt2.mp4  (secadora)
//   img/cmegenerador/cmeg_mv_falt3.jpg · broll/cmegenerador/cmeg_mv_falt3.mp4  (hornilla)
//   img/cmegenerador/cmeg_mv_falt4.jpg · broll/cmegenerador/cmeg_mv_falt4.mp4  (calentador+termómetro)
//   img/cmegenerador/cmeg_mv_falt5.jpg · broll/cmegenerador/cmeg_mv_falt5.mp4  (bomba de pozo)
...
const RING = [
  { src: "img/cmegenerador/cmeg_mv_falt1.jpg", kind: "photo" as const, label: "AIRE CENTRAL" },
  { src: "img/cmegenerador/cmeg_mv_falt2.jpg", kind: "photo" as const, label: "SECADORA" },
  { src: "img/cmegenerador/cmeg_mv_falt3.jpg", kind: "photo" as const, label: "HORNILLA" },
  { src: "img/cmegenerador/cmeg_mv_falt4.jpg", kind: "photo" as const, label: "CALENTADOR" },
];
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: V.ink0, overflow: "hidden" }}>
      ...
      <Layers cam={cam}>
        ...
        <Plane z={-820}>
          {f < A3
            ? <PhotoPlane src="img/cmegenerador/cmeg_mv_falt1.jpg" z={0} scale={1.24} dim={0.66} tint={V.sky} />
            : <PhotoPlane src="img/cmegenerador/cmeg_mv_falt5.jpg" z={0} scale={1.2} dim={0.62} tint={tintA} />}
        </Plane>
        ...
        <Plane z={0}>
          ...
          {verHeroe && (
            heroVideo ? (
              ...
              <MediaCard
                src="img/cmegenerador/cmeg_mv_falt1.jpg" kind="photo"
                w={heroW} h={heroH} x={heroX} y={heroY} z={heroZ} ry={heroRy}
          ...
          {verTanque && (
            tanqueVideo ? (
              ...
              <MediaCard
                src="img/cmegenerador/cmeg_mv_falt4.jpg" kind="photo"
                w={tkW} h={tkH} x={tkX} y={tkY} z={tkZ} ry={tkRy}
          ...
          {verBomba && (
            bombaVideo ? (
              ...
              <MediaCard
                src="img/cmegenerador/cmeg_mv_falt5.jpg" kind="photo"
                w={puW} h={puH} x={puX} y={puY} z={puZ} ry={puRy}
