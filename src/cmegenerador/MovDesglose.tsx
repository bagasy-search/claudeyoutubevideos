...
export const MovDesglose: React.FC<{ acto: number; gFrame: number }> = ({ acto, gFrame }) => {
  ...
  const piezas: { foto: string; label: string; nombre: string; fig: string; from: Geo; t0: number; t1: number; hi: number[] }[] = [
    { foto: "img/cmegenerador/cmeg_mv_desg1.png", label: "MÁQUINA · $4.700", nombre: "LA MÁQUINA", fig: "$4.700",
      from: { x: 56 - WPCT, y: 44, w: 880, h: 496, z: 70, ry: -6, rx: 0 }, t0: 262, t1: 336, hi: [150, 230] },
    { foto: "img/cmegenerador/cmeg_mv_desg2.png", label: "TRANSFERENCIA · $1.800", nombre: "TRANSFERENCIA", fig: "$1.800",
      from: { x: 57, y: 44, w: 860, h: 496, z: 80, ry: 5, rx: 0 }, t0: 556, t1: 620, hi: [862, 946] },
    { foto: "img/cmegenerador/cmeg_mv_desg3.png", label: "ELÉCTRICA · $800", nombre: "ELÉCTRICA", fig: "$800",
      from: { x: 57, y: 45, w: 880, h: 500, z: 110, ry: -4, rx: 0 }, t0: 876, t1: 934, hi: [1142, 1224] },
    { foto: "img/cmegenerador/cmeg_mv_desg4.png", label: "LA LOSA · 200 KG", nombre: "LA LOSA", fig: "200 KG",
      from: { x: 57, y: 44, w: 880, h: 505, z: 40, ry: 0, rx: 0 }, t0: 1140, t1: 1206, hi: [1206, 1250] },
    { foto: "img/cmegenerador/cmeg_mv_desg5.png", label: "EL GAS · $900", nombre: "EL GAS", fig: "$900",
    ...
    <AbsoluteFill style={{ backgroundColor: V.ink0 }}>
      ...
      <Layers cam={cam}>
        ...
        <Plane z={0} style={{ transform: `translateZ(-620px) translateX(${(-camX * 0.72).toFixed(1)}px)` }}>
          <PhotoPlane src="img/cmegenerador/cmeg_mv_desg1.png" kind="photo" z={0} scale={1.72}
          ...
          {verPlaca && (
            <div style={{
              ...
              <div style={{
                ...
                <MediaCard src="img/cmegenerador/cmeg_mv_desg4.png" kind="photo"
