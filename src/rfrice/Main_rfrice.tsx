// Main_rfrice.tsx — GENERADO por _work/rfrice/montaje.mjs. NO editar a mano.
import React from "react";
import { AbsoluteFill, Audio, Sequence, staticFile } from "remotion";
import { BASE, AVATAR, OVERLAYS, OV2, HERO, SFX, TOTAL_FRAMES_RFRICE } from "./cues.gen";
...
export const MainRfrice: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#0A1220" }}>
    ...
    <Capa cues={OV2} />
    <Capa cues={HERO} />
    <Audio src={staticFile("rfrice.m4a")} />
    {SFX.map((s, k) => (
