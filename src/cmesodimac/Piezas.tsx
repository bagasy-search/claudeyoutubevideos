// Piezas.tsx — las tres primitivas de la capa base/overlay del montaje de `cmeenchufe`.
 ...
 *  ⛔ `OffthreadVideo`, NUNCA `<Video>`: en el RENDER, `<Video>` usa un elemento HTML que busca por
 *  tiempo y no acierta el cuadro exacto -> se repiten y saltean cuadros de forma irregular y se ve
 *  como TIRÓN. `OffthreadVideo` extrae el frame con ffmpeg. Costó tres renders descubrirlo. */
