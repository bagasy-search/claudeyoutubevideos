          ...
          {o4 > 0 && (
            <AbsoluteFill style={{ transformStyle: "preserve-3d", opacity: o4 }}>
              ...
              <Plane z={140}>
                ...
                <IconPng src="img/cmesodimac/cmes_ic_telefono.png" x={13} y={22} size={104} z={26} opacity={0.9} />
                <IconPng src="img/cmesodimac/cmes_ic_cuaderno.png" x={24} y={22} size={104} z={26} opacity={0.9} />
              </Plane>
            </AbsoluteFill>
          )}
        </AbsoluteFill>
