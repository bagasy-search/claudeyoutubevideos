// Piezas.tsx — primitivas del montaje VLOG de `tcbriquetas` (Taller de Claudio).
// Base: src/pinvacas/Piezas.tsx. Vara del canal: planos CRUDOS a pantalla completa, cortes secos,
