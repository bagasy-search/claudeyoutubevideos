...
import { V, F_DISPLAY, F_BODY, rgba, CL, eOut, ramp, spr, GOLD, src, Atmosphere, Finish, Plane, useCam } from "./RoweDepth";
      ...
      <AbsoluteFill style={{ transform: `scale(${cam.scale.toFixed(4)})`, transformOrigin: "50% 55%" }}>
        ...
        <Plane depth={0.6} camX={cam.camX} camY={cam.camY} z={2}>
          <div style={{
            ...
            background: `linear-gradient(145deg, ${rgba("#2A1E14", 0.97)} 0%, ${rgba("#17110C", 0.98)} 100%)`,
