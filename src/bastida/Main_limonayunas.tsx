...
const OVERLAY: {from: number; dur: number; node: React.ReactNode}[] = [
  ...
  {from: F.nefronas, dur: 200, node: <KeyWord word="UN MILLÓN DE FILTROS" sub="las nefronas" color={BAS.aqua} />},
  ...
  {from: F.cuidado_sal, dur: 200, node: <KeyWord word="LA SAL ESCONDIDA" sub="fiambre, caldito, snacks" color={BAS.no} />},
