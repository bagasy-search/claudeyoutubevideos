...
// ── CANAL "Dr. Federer — The Nightly Remedy" (EN) · turkeyneck ─────────────
// Audio = máster Fish (voz del canal). Avatar = InfiniteTalk/RunPod SÓLO en las ventanas visibles
// (reel `turkeyneck_avatar.mp4`, recortado con trimBefore). Todo video por OffthreadVideo.
export const TOTAL_FRAMES_TURKEYNECK = TOTAL_FRAMES;
const AVATAR_REEL = "turkeyneck_avatar.mp4";
...
export const MainTurkeyneck: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#0E1D23" }}>
    <Audio src={staticFile("turkeyneck.m4a")} />
