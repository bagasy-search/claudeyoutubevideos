...
// ── CANAL "Dr. Federer — The Nightly Remedy" (EN) · she78 ─────────────
// Audio = máster Fish (voz del canal). Avatar = InfiniteTalk/RunPod SÓLO en las ventanas visibles
// (reel `she78_avatar.mp4`, recortado con trimBefore). Todo video por OffthreadVideo.
export const TOTAL_FRAMES_SHE78 = TOTAL_FRAMES;
const AVATAR_REEL = "s78/she78_avatar.mp4";
...
export const MainShe78: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#0E1D23" }}>
    <Audio src={staticFile("s78/she78.m4a")} />
