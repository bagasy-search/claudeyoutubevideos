...
export const LoopLockVd5: React.FC<{ durationInFrames: number; title?: string; sub?: string }> = ({ title = "El error del 90%", sub = "empeora la uña en vez de arreglarla — te lo digo al final" }) => {
