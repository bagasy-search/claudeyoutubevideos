// FocusCards_vlhdvm2isyur.tsx — componente PROPIO del slug (aislado, no toca archivos compartidos).
...
export const FocusCardsVlh: React.FC<{ durationInFrames: number; items: Item[]; title?: string }> = ({ durationInFrames, items, title }) => {
