// FocusCards_v8v252t741it.tsx — componente PROPIO del slug (aislado, no toca archivos compartidos).
...
export const FocusCardsV8: React.FC<{ durationInFrames: number; items: Item[]; title?: string }> = ({ durationInFrames, items, title }) => {
