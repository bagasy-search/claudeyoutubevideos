...
export const LoopLockV89: React.FC<{ durationInFrames: number; title?: string; sub?: string }> = ({ title = "The mistake that ruins it for 9 of 10", sub = "used wrong, it makes your spots DARKER — I'll show you why at the end" }) => {
