// LoopLock_v3iuzgxce9vg.tsx — componente PROPIO del slug (aislado). Tarjeta CANDADO para plantar el
...
export const LoopLockUro: React.FC<{ durationInFrames: number; title?: string; sub?: string }> = ({ title = "The mistake that ruins it for 9 of 10", sub = "used wrong, it makes your spots DARKER — I'll show you why at the end" }) => {
