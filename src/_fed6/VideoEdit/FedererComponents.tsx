...
export function renderFedererComp(beat: any, d: number): React.ReactNode {
  switch (beat.kind) {
    ...
    case "checklist":
      return <ChecklistReveal durationInFrames={d} theme={T} title={beat.title} eyebrow={beat.eyebrow} stamp={beat.stamp} items={(beat.items || []).map((i: any) => (typeof i === "string" ? i : i.text))} />;
    case "process":
