// Main_fcsunaclavada.tsx — GENERADO por build_fcsunaclavada.mjs. NO editar a mano.
import React from "react";
import { AbsoluteFill, Audio, Sequence, staticFile } from "remotion";
import { CUES, OVERLAYS } from "../../VideoEdit/cues_fcsunaclavada.gen";

export const TOTAL_FRAMES_FCSUNACLAVADA = 72699;
const F = (s: number) => Math.round(s * 30);

export const MainFcsunaclavada: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#08110F" }}>
    ...
    <Audio src={staticFile("fcsunaclavada.m4a")} />
  </AbsoluteFill>
);
