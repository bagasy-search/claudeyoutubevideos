// Pizarra_v8v252t7cjxe — variante de PizarraExplica con UN fix.
// BUG del original (visible SOLO cuando el board va SIN imágenes): el nodo numerado se posiciona
// absoluto en x≈81-115 y la fila de textos arranca en x=72 (marginLeft 8), así que el círculo TAPA
// el primer carácter de cada ítem ("5 mmHg" se lee "mmHg"). Con imagen no se nota porque el thumb
// empuja el texto. Acá el margen se calcula según haya thumb o no.
// No se toca el compartido: lo usan otros videos.
...
export const PizarraV8: React.FC<{
        ...
        {items.map((it, i) => {
          ...
          return (
            <div key={i} style={{ position: "absolute", left: 64, right: 60, top: rowY, opacity: p, transform: `translateX(${appearX}px)` }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 26, marginLeft: it.image ? 8 : 74, height: rowH - 20 }}>
                {it.image && (
                  <div
                    style={{
                      flex: "0 0 auto",
