// FocusCards_v3iuzgxce9vg.tsx — componente PROPIO del slug (aislado, no toca archivos compartidos).
...
export const FocusCardsUro: React.FC<{ durationInFrames: number; items: Item[]; title?: string }> = ({ durationInFrames, items, title }) => {
