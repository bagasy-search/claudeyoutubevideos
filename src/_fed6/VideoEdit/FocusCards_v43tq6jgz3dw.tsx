// FocusCards_v43tq6jgz3dw.tsx — componente PROPIO del slug (aislado, no toca archivos compartidos).
...
export const FocusCardsV43: React.FC<{ durationInFrames: number; items: Item[]; title?: string }> = ({ durationInFrames, items, title }) => {
