// LoopLock_v8v252t741it.tsx — componente PROPIO del slug (aislado). Tarjeta CANDADO para plantar el
...
export const LoopLockV8: React.FC<{ durationInFrames: number; title?: string; sub?: string }> = ({ title = "El error del 90%", sub = "empeora la uña en vez de arreglarla — te lo digo al final" }) => {
