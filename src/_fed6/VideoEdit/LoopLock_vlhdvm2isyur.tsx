// LoopLock_vlhdvm2isyur.tsx — componente PROPIO del slug (aislado). Tarjeta CANDADO para plantar el
// loop grande del hook: "el error que hace que el romero no sirva… te lo digo al final".
...
export const LoopLockVlh: React.FC<{ durationInFrames: number; title?: string; sub?: string }> = ({ title = "El error del 90%", sub = "no es la marca ni la cantidad: es el LUGAR — te lo digo al final" }) => {
