...
export const ImgOr: React.FC<{
  ...
  // ★ SIN src: superficie neutra themeada. NUNCA el paisaje sembrado — se leía como asset roto.
  // De raíz: un slot de imagen sin foto se ve intencional. Los componentes con foto pasan `src`.
  void seed;
  return (
    <div
      style={{
