          ...
          return (
            <div key={i} style={{
              ...
              <div style={{
                ...
                border: `1px solid ${rgba("#DCEBF7", 0.45)}`,
                boxShadow: `0 44px 90px ${rgba("#02060B", 0.7)}, 0 10px 26px ${rgba("#02060B", 0.5)}${glowK ? `, 0 0 0 3px ${rgba(V.brass, 0.95 * glowK)}, 0 0 70px ${rgba(V.brass, 0.55 * glowK)}` : ""}`,
              }}>
                ...
                <div style={{ position: "absolute", inset: 0, background: rgba("#0A1624", interpolate(u, [0, 1], [0.55, 0])) }} />
