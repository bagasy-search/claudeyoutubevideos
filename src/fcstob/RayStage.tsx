...
/** La marca de esquina del canal para este video: la gota (el agua donde no debe estar). */
export const Keyring: React.FC<{ size?: number }> = ({ size = 34 }) => (
  <svg width={size} height={size} viewBox="0 0 40 40" style={{ overflow: "visible" }}>
    <path d="M20 6 C20 6 30 17.5 30 24 a10 10 0 0 1 -20 0 C10 17.5 20 6 20 6 z" fill="none" stroke={V.brass} strokeWidth="2.4" strokeLinejoin="round" />
    <path d="M16 24.5 a4 4 0 0 0 4 4" fill="none" stroke={V.brass} strokeWidth="1.9" strokeLinecap="round" opacity="0.6" />
    <ellipse cx="20" cy="34.6" rx="9" ry="1.6" fill={V.brass} opacity="0.28" />
  </svg>
);
