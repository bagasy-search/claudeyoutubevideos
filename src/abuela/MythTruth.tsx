// MythTruth.tsx — MITO (✗ rojo, tachado) vs VERDAD (✓ terracota). El verdad entra despues.
// ⛔ Los chips van EN ESPANOL: este canal es ES. Estaban HARDCODEADOS en ingles en el kit de dale
//    y `check_defaults.mjs` NO los caza (no son defaults pisables, son props literales del JSX).
//    Lo detecto el AUDITOR de vision leyendo el frame. Revisar lo mismo al clonar otros kits.
