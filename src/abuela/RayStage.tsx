// RayStage.tsx — ESCENARIO COMPARTIDO del canal "Abuela Rosa: Sabores de Antes" (ES, narrador puro).
//
...
//
// MARCA: madera quemada + TERRACOTA/CREMA (la cocina de antes) + LADRILLO sobrio para el remate.
// Serif suave (Garamond) para display, Inter para cuerpo. Nada de cian/alarma: es cálido y vintage.
// ⛔ Clonado de src/dale/ (narrator-video Fase 0): NO se renombran archivos ni exports — los imports
//    son relativos y resuelven dentro de esta carpeta. Renombrar da React error #130 y mata los chunks.
//
...
import { F_GARAMOND, F_INTER } from "../VideoEdit/kit/premium/theme";

// ── PALETA / TIPOGRAFÍA ──────────────────────────────────────────────────────────────────────
export const V = {
  ink0: "#1A120B",       // madera quemada — el fondo del canal
  ink1: "#241810",
  ink2: "#2E2016",
  brass: "#B5622F",      // TERRACOTA — el acento del canal (la olla de barro, el ladrillo de la cocina)
  brassSoft: "#E8C89A",  // crema tostada — títulos, resaltados
  amber: "#E8C89A",
  danger: "#8C3A22",     // LADRILLO — el remate, nunca alarma (este canal no asusta)
  dangerSoft: "#A85138",
  white: "#F6EEDD",      // crema del mantel
  bone: "#CDBB9E",
  steel: "#9A8B76",      // peltre viejo (no acero azulado)
  ok: "#6E8B4A",         // verde de la huerta
};
export const F_DISPLAY = F_GARAMOND;
