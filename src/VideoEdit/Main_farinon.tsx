// Main_farinon.tsx — GENERADO por build_farinon.mjs. NO editar a mano.
import React from "react";
import { AbsoluteFill, Audio, OffthreadVideo, Sequence, staticFile, useCurrentFrame } from "remotion";
import { CUES, OVERLAYS } from "./cues_farinon.gen";
import { TOTAL_FRAMES_FARINON, AVATAR_SRC_FARINON } from "./avatar_farinon.gen";
...
const AvatarPiso: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#0A0F15", overflow: "hidden" }}>
      <OffthreadVideo
        src={staticFile(AVATAR_SRC_FARINON)}
        muted
...
export const MainFarinon: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#0A0F15" }}>
    <Sequence from={0} durationInFrames={TOTAL_FRAMES_FARINON} layout="none">
      <AvatarPiso />
    </Sequence>
    ...
    <Audio src={staticFile("farinon.m4a")} />
  </AbsoluteFill>
);

export { TOTAL_FRAMES_FARINON };
