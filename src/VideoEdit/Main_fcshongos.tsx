// Main_fcshongos.tsx — GENERADO por build_fcshongos.mjs. NO editar a mano.
import React from "react";
import { AbsoluteFill, Audio, Sequence, staticFile } from "remotion";
import { CUES, OVERLAYS } from "./cues_fcshongos.gen";

export const TOTAL_FRAMES_FCSHONGOS = 48813;
const F = (s: number) => Math.round(s * 30);

export const MainFcshongos: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#08110F" }}>
    ...
    <Audio src={staticFile("fcshongos.m4a")} />
  </AbsoluteFill>
);
