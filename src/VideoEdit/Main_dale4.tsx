// Main_dale4.tsx — GENERADO por build_dale4.mjs. NO editar a mano.
import React from "react";
import { AbsoluteFill, Audio, Sequence, staticFile } from "remotion";
import { CUES, OVERLAYS } from "./cues_dale4.gen";
import { TOTAL_FRAMES_DALE4 } from "./avatar_dale4.gen";

const F = (s: number) => Math.round(s * 30);

export const MainDale4: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#0A0F15" }}>
    ...
    <Audio src={staticFile("dale4.m4a")} />
  </AbsoluteFill>
);

export { TOTAL_FRAMES_DALE4 };
