// Main_fcscanas.tsx — GENERADO por build_fcscanas.mjs. NO editar a mano.
import React from "react";
import { AbsoluteFill, Audio, Sequence, staticFile } from "remotion";
import { CUES, OVERLAYS } from "./cues_fcscanas.gen";

export const TOTAL_FRAMES_FCSCANAS = 84054;
const F = (s: number) => Math.round(s * 30);

export const MainFcscanas: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#08110F" }}>
    ...
    <Audio src={staticFile("fcscanas.m4a")} />
  </AbsoluteFill>
);
