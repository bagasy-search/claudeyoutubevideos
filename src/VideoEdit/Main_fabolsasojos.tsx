// Main_fabolsasojos.tsx — GENERADO por build_fabolsasojos.mjs. NO editar a mano.
import React from "react";
import { AbsoluteFill, Audio, Sequence, staticFile } from "remotion";
import { CUES, OVERLAYS } from "./cues_fabolsasojos.gen";

export const TOTAL_FRAMES_FABOLSASOJOS = 45698;
const F = (s: number) => Math.round(s * 30);

export const MainFabolsasojos: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#08110F" }}>
    ...
    <Audio src={staticFile("fabolsasojos.m4a")} />
  </AbsoluteFill>
);
