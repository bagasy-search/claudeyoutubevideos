// Main_mdfreezer.tsx — GENERADO. NO editar a mano.
import { AbsoluteFill, Audio, Sequence, staticFile } from "remotion";
import { CUES, OVERLAYS } from "./cues_mdfreezer.gen";

export const TOTAL_FRAMES_MDFREEZER = 43102;

export const MainMdFreezer: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#0A0A0C" }}>
    ...
    <Audio src={staticFile("mdfreezer.m4a")} />
    {CUES.map((cue) => (
