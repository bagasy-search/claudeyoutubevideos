// Main_famascarroz.tsx — GENERADO por build_famascarroz.mjs. NO editar a mano.
import React from "react";
import { AbsoluteFill, Audio, Sequence, staticFile } from "remotion";
import { CUES, OVERLAYS } from "./cues_famascarroz.gen";

export const TOTAL_FRAMES_FAMASCARROZ = 45336;
const F = (s: number) => Math.round(s * 30);

export const MainFamascarroz: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#08110F" }}>
    ...
    <Audio src={staticFile("famascarroz.m4a")} />
  </AbsoluteFill>
);
