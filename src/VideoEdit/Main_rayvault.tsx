...
<Sequence key="rv_005" from={430} durationInFrames={150}><AbsoluteFill><OffthreadVideo muted src={staticFile("broll/rayvault_h_01_r1.mp4")} playbackRate={1.000000} style={{width:'100%',height:'100%',objectFit:'cover'}} /></AbsoluteFill></Sequence>
<Sequence key="rv_006" from={580} durationInFrames={144}><AbsoluteFill><OffthreadVideo muted src={staticFile("broll/rayvault_rv_006.mp4")} playbackRate={1.000000} style={{width:'100%',height:'100%',objectFit:'cover'}} /></AbsoluteFill></Sequence>
...
<Sequence key="rv_098b" from={19966} durationInFrames={180}><AbsoluteFill><BigStat durationInFrames={180} {...({"value":"1 inch","unit":"","caption":"Nominal throw — verify installed travel","tone":"brass","bed":"img/rayvault_rv_098b.jpg"} as any)} /></AbsoluteFill></Sequence>
...
<Sequence key="rv_108" from={22096} durationInFrames={293}><AbsoluteFill><RouteFlow durationInFrames={293} {...({"title":"Projection is not engagement","kicker":"FOLLOW THE CONNECTION","steps":[{"label":"Door edge"},{"label":"Projection"},{"label":"Door gap"},{"label":"Receiving pocket"},{"label":"Sound support"}],"bed":"img/rayvault_rv_108.jpg"} as any)} /></AbsoluteFill></Sequence>
...
<Sequence key="rv_127" from={26128} durationInFrames={304}><AbsoluteFill><Foto src="img/rayvault_rv_127.jpg" seed={26128} /></AbsoluteFill></Sequence>
...
<Sequence key="rv_163b" from={34021} durationInFrames={247}><AbsoluteFill><Foto src="img/rayvault_rv_163b.jpg" seed={34021} /></AbsoluteFill></Sequence>
...
<Sequence key="rv_202" from={42477} durationInFrames={170}><AbsoluteFill><Foto src="img/rayvault_rv_202.jpg" seed={42477} /></AbsoluteFill></Sequence>
...
<Sequence key="rv_216" from={45285} durationInFrames={97}><AbsoluteFill><Foto src="img/rayvault_rv_216.jpg" seed={45285} /></AbsoluteFill></Sequence>
...
<Sequence key="rv_219" from={45839} durationInFrames={289}><AbsoluteFill><BigStat durationInFrames={289} {...({"value":"$20–50","unit":"","caption":"Reinforced strike + fasteners","tone":"brass","bed":"img/rayvault_rv_219.jpg"} as any)} /></AbsoluteFill></Sequence>
<Sequence key="rv_220" from={46128} durationInFrames={226}><AbsoluteFill><Foto src="img/rayvault_rv_220.jpg" seed={46128} /></AbsoluteFill></Sequence>
...
<Sequence key="rv_226b" from={47258} durationInFrames={114}><AbsoluteFill><BigStat durationInFrames={114} {...({"value":"$35","unit":"","caption":"Example: strike + fasteners","tone":"brass","bed":"img/rayvault_rv_226b.jpg"} as any)} /></AbsoluteFill></Sequence>
...
<Sequence key="rv_249" from={51647} durationInFrames={49}><AbsoluteFill><OffthreadVideo muted src={staticFile("broll/rayvault_rv_249.mp4")} playbackRate={1.000000} style={{width:'100%',height:'100%',objectFit:'cover'}} /></AbsoluteFill></Sequence>
...
<Sequence key="over_rv_241_overlay" from={50385} durationInFrames={313} layout="none"><RayCta durationInFrames={313} {...({"title":"The One Afternoon Door","sub":"The door inspection guide is in development.","domain":"Guide in development","eyebrow":"Coming later","showQr":false} as any)} /></Sequence>
