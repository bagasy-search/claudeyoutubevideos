// Main_fcstaza9.tsx — GENERADO por build_fcstaza9.mjs. NO editar a mano.
import React from "react";
import { AbsoluteFill, Audio, OffthreadVideo, Sequence, staticFile, useCurrentFrame } from "remotion";
import { RayAvatar } from "../fcsclv/RayStage";
import { CUES, OVERLAYS } from "./cues_fcstaza9.gen";
import { TOTAL_FRAMES_FCSTAZA9, AVATAR_FRAMES_FCSTAZA9, AVATAR_SRC_FCSTAZA9, LOOP_FRAMES_FCSTAZA9 } from "./avatar_fcstaza9.gen";
...
const AvatarPiso: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#0A0F15", overflow: "hidden" }}>
      <OffthreadVideo
        src={staticFile(AVATAR_SRC_FCSTAZA9)}
        muted
...
export const MainFcstaza9: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#0A0F15" }}>
    ...
    <Sequence from={0} durationInFrames={AVATAR_FRAMES_FCSTAZA9} layout="none">
      <AvatarPiso />
    </Sequence>
    <Sequence from={AVATAR_FRAMES_FCSTAZA9} durationInFrames={Math.max(1, TOTAL_FRAMES_FCSTAZA9 - AVATAR_FRAMES_FCSTAZA9)} layout="none">
      <RayAvatar src={AVATAR_SRC_FCSTAZA9} loopFrames={LOOP_FRAMES_FCSTAZA9} />
    </Sequence>
    ...
    <Audio src={staticFile("fcstaza9.m4a")} />
  </AbsoluteFill>
);

export { TOTAL_FRAMES_FCSTAZA9 };
