// Main_fapiel60.tsx — GENERADO por build_fapiel60.mjs. NO editar a mano.
import React from "react";
import { AbsoluteFill, Audio, OffthreadVideo, Sequence, staticFile, useCurrentFrame } from "remotion";
import { CUES, OVERLAYS } from "./cues_fapiel60.gen";
import { TOTAL_FRAMES_FAPIEL60, AVATAR_SRC_FAPIEL60 } from "./avatar_fapiel60.gen";
...
const AvatarPiso: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#0A0F15", overflow: "hidden" }}>
      <OffthreadVideo
        src={staticFile(AVATAR_SRC_FAPIEL60)}
        muted
...
export const MainFapiel60: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#0A0F15" }}>
    <Sequence from={0} durationInFrames={TOTAL_FRAMES_FAPIEL60} layout="none">
      <AvatarPiso />
    </Sequence>
    ...
    <Audio src={staticFile("fapiel60.m4a")} />
  </AbsoluteFill>
);

export { TOTAL_FRAMES_FAPIEL60 };
