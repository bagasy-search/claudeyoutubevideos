// Main_facrema81.tsx — GENERADO por build_facrema81.mjs. NO editar a mano.
import React from "react";
import { AbsoluteFill, Audio, Sequence, staticFile } from "remotion";
import { CUES, OVERLAYS } from "./cues_facrema81.gen";

export const TOTAL_FRAMES_FACREMA81 = 81423;
const F = (s: number) => Math.round(s * 30);

export const MainFacrema81: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#08110F" }}>
    ...
    <Audio src={staticFile("broll/facrema81/facrema81.m4a")} />
  </AbsoluteFill>
);
