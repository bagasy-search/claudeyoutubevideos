// Main_fedvetdolor.tsx — GENERADO por build_fedvetdolor.mjs. NO editar a mano.
import React from "react";
import { AbsoluteFill, Audio, OffthreadVideo, Sequence, staticFile, useCurrentFrame } from "remotion";
import { RayAvatar } from "../fedvet/RayStage";
import { CUES, OVERLAYS } from "./cues_fedvetdolor.gen";
import { TOTAL_FRAMES_FEDVETDOLOR, AVATAR_FRAMES_FEDVETDOLOR, AVATAR_SRC_FEDVETDOLOR, LOOP_FRAMES_FEDVETDOLOR } from "./avatar_fedvetdolor.gen";
...
const AvatarPiso: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#0A0F15", overflow: "hidden" }}>
      <OffthreadVideo
        src={staticFile(AVATAR_SRC_FEDVETDOLOR)}
        muted
...
export const MainFedvetdolor: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#0A0F15" }}>
    ...
    <Sequence from={0} durationInFrames={AVATAR_FRAMES_FEDVETDOLOR} layout="none">
      <AvatarPiso />
    </Sequence>
    <Sequence from={AVATAR_FRAMES_FEDVETDOLOR} durationInFrames={Math.max(1, TOTAL_FRAMES_FEDVETDOLOR - AVATAR_FRAMES_FEDVETDOLOR)} layout="none">
      <RayAvatar src={AVATAR_SRC_FEDVETDOLOR} loopFrames={LOOP_FRAMES_FEDVETDOLOR} />
    </Sequence>
    ...
    <Audio src={staticFile("fedvetdolor.m4a")} />
  </AbsoluteFill>
);

export { TOTAL_FRAMES_FEDVETDOLOR };
