// Main_fedvet2.tsx — GENERADO por build_fedvet2.mjs. NO editar a mano.
import React from "react";
import { AbsoluteFill, Audio, Sequence, staticFile } from "remotion";
import { CUES, OVERLAYS } from "./cues_fedvet2.gen";
import { TOTAL_FRAMES_FEDVET2 } from "./avatar_fedvet2.gen";

const F = (s: number) => Math.round(s * 30);

export const MainFedvet2: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#0A0F15" }}>
    ...
    <Audio src={staticFile("fedvet2.m4a")} />
  </AbsoluteFill>
);

export { TOTAL_FRAMES_FEDVET2 };
