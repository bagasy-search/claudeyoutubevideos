...
import { CUES, OVERLAYS } from "./cues_cme5.gen";
import { AVATAR_WINDOWS, TOTAL_CME5 } from "./avatar_cme5.gen";
export const TOTAL_FRAMES_CME5 = Math.round(TOTAL_CME5 * 30);
export const MainCme5: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: THEME_VOLT.color.bg0 }}>
    <CinematicWrap grain={0} vignette={0}>
      <AbsoluteFill style={{ backgroundColor: THEME_VOLT.color.bg0 }}>
        ...
        <AvatarLayer src="cme5_opt.mp4" windows={AVATAR_WINDOWS} accent="#C8F000" />
