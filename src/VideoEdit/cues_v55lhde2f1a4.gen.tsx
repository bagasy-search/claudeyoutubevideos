...
export const CUES_V55LHDE2F1A4: V55Cue[] = [
  ...
  { key:"s_05", start:24.6, dur:4.98, kind:"statbig", el:(d) => <StatBig durationInFrames={d} value={12} suffix=" h" eyebrow="NÚMERO" label="entre 12 y" hue="amber" /> },
  ...
  { key:"s_25", start:144.58, dur:5.54, kind:"barcompare", el:(d) => <BarCompare durationInFrames={d} eyebrow="COMPARA" title="El agua" hue="amber" orientation="horizontal" bars={[{label:"Agua",value:1,display:"1×",tone:"cold"},{label:"Sauce",value:3,display:"3×",tone:"amber",winner:true}]} /> },
  { key:"s_27", start:155.42, dur:3.48, kind:"calloutmark", el:(d) => <CalloutMark durationInFrames={d} figure="OK" eyebrow="CLAVE" caption="Ahora sí" hue="amber" /> },
  ...
  { key:"s_39", start:206.94, dur:4.22, kind:"textcardreveal", el:(d) => <TextCardReveal durationInFrames={d} lines={["Tapa","el recipiente"]} /> },
  ...
  { key:"s_47", start:243.48, dur:6, kind:"checklist", el:(d) => <Checklist durationInFrames={d} title="CONTROL" hue="amber" items={[{text:"Puedes",state:"done"},{text:"usar",state:"done"},{text:"el",state:"done"}]} /> },
  { key:"s_49", start:257.22, dur:3.7, kind:"calloutmark", el:(d) => <CalloutMark durationInFrames={d} figure="OK" eyebrow="CLAVE" caption="Pero siempre" hue="amber" /> },
  ...
  { key:"s_59", start:298.56, dur:6.64, kind:"textcardreveal", el:(d) => <TextCardReveal durationInFrames={d} lines={["Empieza con","una especie"]} /> },
  ...
  { key:"s_67", start:338.38, dur:5.22, kind:"barcompare", el:(d) => <BarCompare durationInFrames={d} eyebrow="COMPARA" title="Debe tener" hue="amber" orientation="horizontal" bars={[{label:"Agua",value:1,display:"1×",tone:"cold"},{label:"Sauce",value:3,display:"3×",tone:"amber",winner:true}]} /> },
  { key:"s_68", start:343.6, dur:6.44, kind:"calloutmark", el:(d) => <CalloutMark durationInFrames={d} figure="OK" eyebrow="CLAVE" caption="Allí hay" hue="amber" /> },
  ...
  { key:"s_87", start:419.92, dur:4.76, kind:"calloutmark", el:(d) => <CalloutMark durationInFrames={d} figure="OK" eyebrow="CLAVE" caption="Si cambias" hue="amber" /> },
  ...
  { key:"s_99", start:470.76, dur:3.3, kind:"textcardreveal", el:(d) => <TextCardReveal durationInFrames={d} lines={["Cambia el","agua si"]} /> },
  ...
  { key:"s_108", start:506.6, dur:5.46, kind:"checklist", el:(d) => <Checklist durationInFrames={d} title="CONTROL" hue="amber" items={[{text:"Mira",state:"done"},{text:"también",state:"done"},{text:"el",state:"done"}]} /> },
  { key:"s_109", start:512.06, dur:4.4, kind:"calloutmark", el:(d) => <CalloutMark durationInFrames={d} figure="OK" eyebrow="CLAVE" caption="Un esqueje" hue="amber" /> },
  ...
  { key:"s_120", start:558.1, dur:3.18, kind:"textcardreveal", el:(d) => <TextCardReveal durationInFrames={d} lines={["Coloca","al menos"]} /> },
  ...
  { key:"s_128", start:599.1, dur:6.04, kind:"calloutmark", el:(d) => <CalloutMark durationInFrames={d} figure="OK" eyebrow="CLAVE" caption="Cuando tenga" hue="amber" /> },
  ...
  { key:"s_136", start:634.12, dur:2.9, kind:"textcardreveal", el:(d) => <TextCardReveal durationInFrames={d} lines={["Después","reduce la"]} /> },
  ...
  { key:"s_143", start:668.46, dur:7.3, kind:"checklist", el:(d) => <Checklist durationInFrames={d} title="CONTROL" hue="amber" items={[{text:"La",state:"done"},{text:"edad",state:"done"},{text:"también",state:"done"}]} /> },
  { key:"s_145", start:680.5, dur:4.36, kind:"calloutmark", el:(d) => <CalloutMark durationInFrames={d} figure="OK" eyebrow="CLAVE" caption="Otras se" hue="amber" /> },
  ...
  { key:"s_155", start:731.86, dur:6.36, kind:"textcardreveal", el:(d) => <TextCardReveal durationInFrames={d} lines={["El","ácido indolbutírico"]} /> },
  ...
  { key:"s_175", start:834.7, dur:3.56, kind:"textcardreveal", el:(d) => <TextCardReveal durationInFrames={d} lines={["porque esa","especie ya"]} /> },
  ...
  { key:"s_184", start:878.3, dur:5, kind:"checklist", el:(d) => <Checklist durationInFrames={d} title="CONTROL" hue="amber" items={[{text:"No",state:"done"},{text:"propades",state:"done"},{text:"una",state:"done"}]} /> },
  { key:"s_186", start:887.48, dur:5.48, kind:"checklist", el:(d) => <Checklist durationInFrames={d} title="CONTROL" hue="amber" items={[{text:"No invasoras",state:"done"},{text:"No protegidas",state:"done"},{text:"Propaga legal",state:"done"}]} /> },
  { key:"s_187", start:892.96, dur:4.32, kind:"calloutmark", el:(d) => <CalloutMark durationInFrames={d} figure="OK" eyebrow="CLAVE" caption="Tener una" hue="amber" /> },
  { key:"s_189", start:900.68, dur:3.06, kind:"kineticheadline", el:(d) => <KineticHeadline durationInFrames={d} eyebrow="CLAVE" hue="amber" size={82} tokens={[{t:"GRUPO"},{t:"1.",hl:true}]} /> },
  { key:"s_190", start:903.74, dur:4.22, kind:"kineticquote", el:(d) => <KineticQuote durationInFrames={d} eyebrow="PRINCIPIO" hue="amber" words={parseQuote("Albaca")} /> },
  { key:"s_193", start:916.9, dur:6.22, kind:"textcardreveal", el:(d) => <TextCardReveal durationInFrames={d} lines={["Grupo","2."]} /> },
  { key:"s_194", start:923.12, dur:5.84, kind:"processsteps", el:(d) => <ProcessSteps durationInFrames={d} title="MÉTODO" hue="amber" steps={[{title:"Aquí"},{title:"importa"},{title:"mucho"}]} /> },
  { key:"s_196", start:935.02, dur:8.18, kind:"textcardreveal", el:(d) => <TextCardReveal durationInFrames={d} lines={["Grupo","3."]} /> },
  { key:"s_197", start:943.2, dur:6, kind:"splitlist", el:(d) => <SplitList durationInFrames={d} title="PUNTOS CLAVE" items={["Pero","cada","especie tiene"]} accent="tan" /> },
  { key:"s_198", start:949.2, dur:5.18, kind:"checklist", el:(d) => <Checklist durationInFrames={d} title="CONTROL" hue="amber" items={[{text:"Grupo",state:"done"},{text:"4.",state:"done"}]} /> },
  { key:"s_200", start:960.54, dur:4.2, kind:"rulenumberscene", el:(d) => <RuleNumberScene durationInFrames={d} number="04" label="REGLA" title="Puedes" hue="amber" /> },
  ...
  { key:"s_202", start:970.02, dur:4.02, kind:"calloutmark", el:(d) => <CalloutMark durationInFrames={d} figure="5" eyebrow="CLAVE" caption="5 minutos" hue="amber" /> },
  { key:"s_204", start:979.74, dur:7.22, kind:"checklist", el:(d) => <Checklist durationInFrames={d} title="CONTROL" hue="amber" items={[{text:"Si",state:"done"},{text:"cortas",state:"done"},{text:"al",state:"done"}]} /> },
  { key:"s_205", start:986.96, dur:6.32, kind:"checklist", el:(d) => <Checklist durationInFrames={d} title="CONTROL" hue="amber" items={[{text:"Tallo húmedo",state:"done"},{text:"Corte rápido",state:"done"},{text:"Agua lista",state:"done"}]} /> },
  { key:"s_208", start:1004.24, dur:3.34, kind:"calloutmark", el:(d) => <CalloutMark durationInFrames={d} figure="OK" eyebrow="CLAVE" caption="Toma los" hue="amber" /> },
  { key:"s_209", start:1007.58, dur:3.26, kind:"kineticheadline", el:(d) => <KineticHeadline durationInFrames={d} eyebrow="CLAVE" hue="amber" size={82} tokens={[{t:"ELIGE"},{t:"CRECIMIENTO"},{t:"SANO",hl:true}]} /> },
  { key:"s_210", start:1010.84, dur:6.36, kind:"kineticquote", el:(d) => <KineticQuote durationInFrames={d} eyebrow="PRINCIPIO" hue="amber" words={parseQuote("Tene el recipiente preparado")} /> },
  { key:"s_212", start:1021.14, dur:3.2, kind:"textcardreveal", el:(d) => <TextCardReveal durationInFrames={d} lines={["Esta parte","vale más"]} /> },
  { key:"s_214", start:1030.96, dur:3.58, kind:"kineticheadline", el:(d) => <KineticHeadline durationInFrames={d} eyebrow="CLAVE" hue="amber" size={82} tokens={[{t:"Y."},{t:"AHORA"},{t:"EL"},{t:"SEGUNDO",hl:true}]} /> },
  ...
  { key:"s_217", start:1043.84, dur:4.52, kind:"optioncompare", el:(d) => <OptionCompare durationInFrames={d} left={{tag:"EVITA",title:"No",sub:"  ",note:"  ",icon:"warn",accent:"orange"}} right={{tag:"MEJOR",title:"plantes el",sub:"  ",note:"  ",icon:"check",accent:"green"}} /> },
  { key:"s_218", start:1048.36, dur:3.58, kind:"splitlist", el:(d) => <SplitList durationInFrames={d} title="PUNTOS CLAVE" items={["Espera","raíces","verdaderas"]} accent="tan" /> },
  { key:"s_221", start:1060.6, dur:3.62, kind:"checklist", el:(d) => <Checklist durationInFrames={d} title="CONTROL" hue="amber" items={[{text:"Las",state:"done"},{text:"sales",state:"done"},{text:"concentradas",state:"done"}]} /> },
  { key:"s_223", start:1067.56, dur:6.24, kind:"rulenumberscene", el:(d) => <RuleNumberScene durationInFrames={d} number="04" label="REGLA" title="Es" hue="amber" /> },
  { key:"s_224", start:1073.8, dur:5.28, kind:"crosssection", el:(d) => <CrossSection durationInFrames={d} eyebrow="CORTE" title="paciencia" hue="amber" layers={[{label:"Tallo",color:"brown"},{label:"Callo",color:"tan"},{label:"Raíces",color:"green"}]} marker={{label:"nodo",atDepth:58,color:"good"}} /> },
  { key:"s_225", start:1079.08, dur:3.6, kind:"kineticheadline", el:(d) => <KineticHeadline durationInFrames={d} eyebrow="CLAVE" hue="amber" size={82} tokens={[{t:"SI"},{t:"QUIERES"},{t:"HACER",hl:true}]} /> },
  { key:"s_226", start:1082.68, dur:3.46, kind:"calloutmark", el:(d) => <CalloutMark durationInFrames={d} figure="OK" eyebrow="CLAVE" caption="Primero" hue="amber" /> },
  { key:"s_227", start:1086.14, dur:3.86, kind:"calloutmark", el:(d) => <CalloutMark durationInFrames={d} figure="8" eyebrow="CLAVE" caption="Retira las" hue="amber" /> },
  { key:"s_230", start:1096.7, dur:5.14, kind:"kineticheadline", el:(d) => <KineticHeadline durationInFrames={d} eyebrow="CLAVE" hue="amber" size={82} tokens={[{t:"CUELA"},{t:"Y."},{t:"ETIQUETA",hl:true}]} /> },
  ...
  { key:"s_233", start:1109.78, dur:3.22, kind:"kineticquote", el:(d) => <KineticQuote durationInFrames={d} eyebrow="PRINCIPIO" hue="amber" words={parseQuote("Misma planta")} /> },
  { key:"s_234", start:1113, dur:4, kind:"textcardreveal", el:(d) => <TextCardReveal durationInFrames={d} lines={["Quinto"]} /> },
  { key:"s_235", start:1117, dur:4.08, kind:"kineticheadline", el:(d) => <KineticHeadline durationInFrames={d} eyebrow="CLAVE" hue="amber" size={82} tokens={[{t:"CAMBIA"},{t:"EL"},{t:"LÍQUIDO"},{t:"SI",hl:true}]} /> },
  ...
  { key:"s_238", start:1130.3, dur:3.84, kind:"textcardreveal", el:(d) => <TextCardReveal durationInFrames={d} lines={["Mantén humedad","al principio"]} /> },
  { key:"s_239", start:1134.14, dur:3.88, kind:"splitlist", el:(d) => <SplitList durationInFrames={d} title="PUNTOS CLAVE" items={["Y.","recuerda","las"]} accent="tan" /> },
  { key:"s_242", start:1148.74, dur:2.66, kind:"checklist", el:(d) => <Checklist durationInFrames={d} title="CONTROL" hue="amber" items={[{text:"No",state:"done"},{text:"me",state:"done"},{text:"digas",state:"done"}]} /> },
  { key:"s_245", start:1162.42, dur:7.1, kind:"rulenumberscene", el:(d) => <RuleNumberScene durationInFrames={d} number="04" label="REGLA" title="un" hue="amber" /> },
  { key:"s_246", start:1169.52, dur:5.64, kind:"crosssection", el:(d) => <CrossSection durationInFrames={d} eyebrow="CORTE" title="Es una" hue="amber" layers={[{label:"Tallo",color:"brown"},{label:"Callo",color:"tan"},{label:"Raíces",color:"green"}]} marker={{label:"nodo",atDepth:58,color:"good"}} /> },
  { key:"s_247", start:1175.16, dur:3.36, kind:"kineticheadline", el:(d) => <KineticHeadline durationInFrames={d} eyebrow="CLAVE" hue="amber" size={82} tokens={[{t:"LA"},{t:"GENTE"},{t:"SENCILLA"},{t:"SABÍA",hl:true}]} /> },
];
