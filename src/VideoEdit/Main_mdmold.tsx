// Main_mdmold.tsx — GENERADO por build_mdmold.mjs. NO editar a mano.
import { AbsoluteFill, Audio, Sequence, staticFile } from "remotion";
import { AvatarLayer } from "./scenes/AvatarLayer";
import { CUES, OVERLAYS, SFXCUES } from "./cues_mdmold.gen";
import { AVATAR_WINDOWS, TOTAL_FRAMES_MDMOLD } from "./avatar_mdmold.gen";

const F = (s: number) => Math.round(s * 30);

export const MainMdMold: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#0A0A0C" }}>
    {/* el avatar es el FONDO GARANTIZADO: dura el video entero y nunca deja hueco */}
    <AvatarLayer src="mdmold_opt.mp4" windows={AVATAR_WINDOWS} accent="#E4322A" />
