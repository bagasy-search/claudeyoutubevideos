// Main_fcsaguanoche.tsx — GENERADO por build_fcsaguanoche.mjs. NO editar a mano.
import React from "react";
import { AbsoluteFill, Audio, Sequence, staticFile } from "remotion";
import { CUES, OVERLAYS } from "./cues_fcsaguanoche.gen";

export const TOTAL_FRAMES_FCSAGUANOCHE = 78330;
const F = (s: number) => Math.round(s * 30);

export const MainFcsaguanoche: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#08110F" }}>
    ...
    <Audio src={staticFile("fcsaguanoche.m4a")} />
  </AbsoluteFill>
);
