...
import { CUES, OVERLAYS } from "./cues_cme4.gen";
import { AVATAR_WINDOWS, TOTAL_CME4 } from "./avatar_cme4.gen";
export const TOTAL_FRAMES_CME4 = Math.round(TOTAL_CME4 * 30);
export const MainCme4: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: THEME_VOLT.color.bg0 }}>
    <CinematicWrap grain={0} vignette={0}>
      <AbsoluteFill style={{ backgroundColor: THEME_VOLT.color.bg0 }}>
        ...
        <AvatarLayer src="cme4_opt.mp4" windows={AVATAR_WINDOWS} accent="#C8F000" />
