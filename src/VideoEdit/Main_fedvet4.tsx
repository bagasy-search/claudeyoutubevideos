// Main_fedvet4.tsx — GENERADO por build_fedvet4.mjs. NO editar a mano.
import React from "react";
import { AbsoluteFill, Audio, Sequence, staticFile } from "remotion";
import { CUES, OVERLAYS } from "./cues_fedvet4.gen";
import { TOTAL_FRAMES_FEDVET4 } from "./avatar_fedvet4.gen";

const F = (s: number) => Math.round(s * 30);

export const MainFedvet4: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#0A0F15" }}>
    ...
    <Audio src={staticFile("fedvet4.m4a")} />
  </AbsoluteFill>
);

export { TOTAL_FRAMES_FEDVET4 };
