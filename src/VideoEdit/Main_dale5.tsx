// Main_dale5.tsx — GENERADO por build_dale5.mjs. NO editar a mano.
import React from "react";
import { AbsoluteFill, Audio, Sequence, staticFile } from "remotion";
import { CUES, OVERLAYS } from "./cues_dale5.gen";
import { TOTAL_FRAMES_DALE5 } from "./avatar_dale5.gen";

const F = (s: number) => Math.round(s * 30);

export const MainDale5: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#0A0F15" }}>
    ...
    <Audio src={staticFile("dale5.m4a")} />
  </AbsoluteFill>
);

export { TOTAL_FRAMES_DALE5 };
