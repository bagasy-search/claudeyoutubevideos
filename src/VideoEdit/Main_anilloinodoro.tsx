...
import { CUES, OVERLAYS } from "./cues_anilloinodoro.gen";
import { AVATAR_WINDOWS, TOTAL_ANILLOINODORO } from "./avatar_anilloinodoro.gen";
...
//
// AVATAR PARCIAL + BUCLE, horneado en anilloinodoro_opt.mp4 (21:19) junto al máster de audio:
...
export const TOTAL_FRAMES_ANILLOINODORO = Math.round(TOTAL_ANILLOINODORO * 30);

export const MainAnilloinodoro: React.FC = () => {
  return (
