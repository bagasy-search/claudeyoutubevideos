// Main_fa70estudios.tsx — GENERADO por build_fa70estudios.mjs. NO editar a mano.
import React from "react";
import { AbsoluteFill, Audio, Sequence, staticFile } from "remotion";
import { CUES, OVERLAYS } from "./cues_fa70estudios.gen";

export const TOTAL_FRAMES_FA70ESTUDIOS = 79320;
const F = (s: number) => Math.round(s * 30);

export const MainFa70estudios: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#08110F" }}>
    ...
    <Audio src={staticFile("fa70estudios.m4a")} />
  </AbsoluteFill>
);
