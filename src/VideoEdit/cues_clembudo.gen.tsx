...
export const CUES: { key: string; start: number; dur: number; el: (d: number) => React.ReactNode }[] = [
  ...
  { key: "componente_13360", start: 13.36, dur: 5.48, el: (d) => <><ClPhoto durationInFrames={d} src="img/clembudo/clembudo_s002.png" seed={13360} /><BigStatReveal durationInFrames={d} theme={THEME_EARTH} {...({"eyebrow":"UN TRABAJO","prefix":"$","value":300,"support":"Entre 80 y 300 dólares, en efectivo, el mismo día que lo terminas","source":""} as any)} /></> },
  ...
  { key: "componente_342680", start: 342.68, dur: 4.82, el: (d) => <><ClPhoto durationInFrames={d} src="img/clembudo/clembudo_s310.png" seed={42680} /><BigStatReveal durationInFrames={d} theme={THEME_EARTH} {...({"eyebrow":"EL KILO DE BÓRAX","prefix":"$","value":5,"support":"Entre 2 y 5 dólares en cualquier ferretería. Rinde 16 litros.","source":""} as any)} /></> },
  { key: "componente_367540", start: 367.54, dur: 5.46, el: (d) => <><ClPhoto durationInFrames={d} src="img/clembudo/clembudo_s312.png" seed={67540} /><HighlightSweep durationInFrames={d} theme={THEME_EARTH} {...({"pre":"La solución de bórax","highlight":"no se enjuaga","post":"nunca","note":"Si la enjuagas, le quitas la protección."} as any)} /></> },
  ...
  { key: "componente_644960", start: 644.96, dur: 5.54, el: (d) => <><ClPhoto durationInFrames={d} src="img/clembudo/clembudo_s430.png" seed={44960} /><PullQuote durationInFrames={d} theme={THEME_EARTH} {...({"quote":"No es dinero fácil. Es dinero simple, que es distinto.","author":"","role":"","image":"img/clembudo/clembudo_s430.png"} as any)} /></> },
