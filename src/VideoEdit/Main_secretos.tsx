...
import planData from '../../_v3/secretos_plan.json';

const FPS = 30;
const BASE_VIDEO = 'secretos-belleza-1960_opt.mp4';
const ACCENT = VAL.gold;

/* ---- ms → frame (contrato del plan) ---- */
const msToF = (ms: number): number => Math.round((ms / 1000) * FPS);

export const TOTAL_FRAMES_SECRETOS = 33800; // round(max(1126660, lastBeatEndMs)/1000*30)
