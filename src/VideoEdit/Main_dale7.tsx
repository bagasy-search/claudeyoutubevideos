// Main_dale7.tsx — GENERADO por build_dale7.mjs. NO editar a mano.
import React from "react";
import { AbsoluteFill, Audio, Sequence, staticFile } from "remotion";
import { CUES, OVERLAYS } from "./cues_dale7.gen";
import { TOTAL_FRAMES_DALE7 } from "./avatar_dale7.gen";

const F = (s: number) => Math.round(s * 30);

export const MainDale7: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#0A0F15" }}>
    ...
    <Audio src={staticFile("dale7.m4a")} />
  </AbsoluteFill>
);

export { TOTAL_FRAMES_DALE7 };
