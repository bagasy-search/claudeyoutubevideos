// Main_fcsclavo.tsx — GENERADO por build_fcsclavo.mjs. NO editar a mano.
import React from "react";
import { AbsoluteFill, Audio, OffthreadVideo, Sequence, staticFile, useCurrentFrame } from "remotion";
import { RayAvatar } from "../fcsclv/RayStage";
import { CUES, OVERLAYS } from "./cues_fcsclavo.gen";
import { TOTAL_FRAMES_FCSCLAVO, AVATAR_FRAMES_FCSCLAVO, AVATAR_SRC_FCSCLAVO, LOOP_FRAMES_FCSCLAVO } from "./avatar_fcsclavo.gen";
...
const AvatarPiso: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#0A0F15", overflow: "hidden" }}>
      <OffthreadVideo
        src={staticFile(AVATAR_SRC_FCSCLAVO)}
        muted
...
export const MainFcsclavo: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#0A0F15" }}>
    ...
    <Sequence from={0} durationInFrames={AVATAR_FRAMES_FCSCLAVO} layout="none">
      <AvatarPiso />
    </Sequence>
    <Sequence from={AVATAR_FRAMES_FCSCLAVO} durationInFrames={Math.max(1, TOTAL_FRAMES_FCSCLAVO - AVATAR_FRAMES_FCSCLAVO)} layout="none">
      <RayAvatar src={AVATAR_SRC_FCSCLAVO} loopFrames={LOOP_FRAMES_FCSCLAVO} />
    </Sequence>
    ...
    <Audio src={staticFile("fcsclavo.m4a")} />
  </AbsoluteFill>
);

export { TOTAL_FRAMES_FCSCLAVO };
