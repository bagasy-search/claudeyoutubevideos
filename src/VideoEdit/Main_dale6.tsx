// Main_dale6.tsx — GENERADO por build_dale6.mjs. NO editar a mano.
import React from "react";
import { AbsoluteFill, Audio, Sequence, staticFile } from "remotion";
import { CUES, OVERLAYS } from "./cues_dale6.gen";
import { TOTAL_FRAMES_DALE6 } from "./avatar_dale6.gen";

const F = (s: number) => Math.round(s * 30);

export const MainDale6: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#0A0F15" }}>
    ...
    <Audio src={staticFile("dale6.m4a")} />
  </AbsoluteFill>
);

export { TOTAL_FRAMES_DALE6 };
