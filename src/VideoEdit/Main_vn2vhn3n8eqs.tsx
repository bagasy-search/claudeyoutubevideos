...
const P: any[] = [
  ...
  /* b084 316.6s */ {"kicker":"LA BARRERA","title":"No es cosmética","hot":["cosmética"],"sub":"Es un órgano de defensa","steps":["Piel rota = puerta abierta","El linoleico sella la puerta","Menos infección"],"mood":"science","nodes":[{"label":"Barrera"},{"label":"Ceramidas"},{"label":"Linoleico"},{"label":"Agua"}],"image":staticFile('img/vn2_fb_science.png')},
  /* b085 320.5s */ {},
  ...
  /* b091 337.5s */ {"kicker":"ALTO OLEICO","value":90,"suffix":"%","decimals":0,"label":"de ácido oleico","sub":"Hasta","mood":"warmdark","image":staticFile('img/vn2_fb_warm.png')},
  /* b092 339.9s */ {"kicker":"ALTO OLEICO","value":10,"suffix":"%","decimals":0,"label":"de linoleico","sub":"Apenas 2 a 10%","mood":"warmdark","image":staticFile('img/vn2_fb_warm.png')},
  /* b093 342.3s */ {},
  ...
  /* b105 380.4s */ {"kicker":"EL ENSAYO","value":148,"decimals":0,"label":"personas","sub":"Edad promedio: 68 años","mood":"cool","image":staticFile('img/vn2_fb_cool.png')},
  ...
  /* b109 394s */ {},
  /* b110 396.3s */ {"kicker":"AL EMPEZAR","value":20,"decimals":0,"label":"pacientes colonizados","sub":"Estafilococo dorado sobre la piel","mood":"warmdark","image":staticFile('img/vn2_fb_warm.png')},
  /* b111 400.3s */ {"kicker":"GRUPO COCO","value":1,"decimals":0,"label":"quedaba colonizado","sub":"Al final del ensayo","mood":"cool","image":staticFile('img/vn2_fb_cool.png')},
  /* b112 402.9s */ {"kicker":"GRUPO OLIVA","value":6,"decimals":0,"label":"seguían colonizados","sub":"De 12 que empezaron","mood":"warmdark","image":staticFile('img/vn2_fb_warm.png')},
  ...
  /* b120 426.7s */ {"kicker":"DE DÓNDE SALE ESE NÚMERO","value":1972,"decimals":0,"label":"el año del test","sub":"Comedogenicidad grado 4","mood":"warmdark","image":staticFile('img/vn2_fb_warm.png')},
  ...
  /* b128 454.8s */ {"kicker":"Rosa mosqueta · perfil graso","value":55,"prefix":"hasta ","suffix":"%","label":"Ácido linoleico","sub":"Entre 36 y 55% del aceite","mood":"science","image":staticFile('img/vn2_c03.png')},
  ...
  /* b131 463.4s */ {},
  /* b132 465.8s */ {"kicker":"Lo mejor que tiene","value":27,"label":"personas","sub":"Un solo estudio piloto","mood":"cool","image":staticFile('img/vn2_fb_cool.png')},
  ...
  /* b154 530.9s */ {"kicker":"El caso publicado","value":69,"suffix":" años","label":"Camionero de reparto","sub":"New England Journal of Medicine, 2012","mood":"warmdark","image":staticFile('img/vn2_c29.png')},
  /* b155 534.9s */ {"kicker":"Al volante","value":25,"suffix":" años","label":"manejando todos los días","sub":"Siempre el mismo lado al sol","mood":"warmdark","image":staticFile('img/vn2_fb_warm.png')},
  ...
  /* b169 584.7s */ {"kicker":"Flament, 2013","value":80.3,"decimals":1,"suffix":"%","label":"del envejecimiento facial visible","sub":"Lo explica el sol","mood":"gold","image":staticFile('img/vn2_fb_gold.png')},
  ...
  /* b173 603.6s */ {"kicker":"El ensayo","value":60,"label":"mujeres posmenopáusicas","sub":"De 49 a 61 años","mood":"science","image":staticFile('img/vn2_c49.png')},
  /* b174 608.3s */ {"kicker":"Duración","value":60,"suffix":" días","label":"de seguimiento","sub":"Medido con cutómetro","mood":"science","image":staticFile('img/vn2_fb_science.png')},
  /* b175 610.9s */ {"mood":"science","src":staticFile('img/vn2_c51.png'),"video":false,"ken":"right"},
  /* b176 615s */ {"kicker":"El resultado","value":15,"prefix":"+","suffix":"%","label":"Elasticidad biológica","sub":"A los 60 días","mood":"gold","image":staticFile('img/vn2_fb_gold.png')},
  /* b177 617.9s */ {"name":"Dr. Valler","role":"Medicina · piel","topic":"El grupo de oliva no mejoró","avatarSrc":null},
  /* b178 621.5s */ {},
  /* b179 624.9s */ {"kicker":"El detalle que no le cuentan","value":25,"suffix":" g","label":"de aceite de argán por día","sub":"Además, tomado","mood":"gold","image":staticFile('img/vn2_c55.png')},
  ...
  /* b240 819.3s */ {},
  /* b241 823.9s */ {},
  /* b242 827s */ {"kicker":"EL ENSAYO","value":15,"decimals":0,"label":"pacientes operados","sub":"Cirugía de cáncer de piel","image":staticFile('img/vn2_e04.png'),"mood":"science"},
  ...
  /* b244 833.1s */ {},
  /* b245 835.3s */ {"kicker":"RESULTADO","value":90,"suffix":"%","decimals":0,"label":"sin ningún efecto o peor","sub":"La vitamina E no mejoró la cicatriz","image":staticFile('img/vn2_e06.png'),"mood":"warmdark"},
  /* b246 841.2s */ {"kicker":"ADEMÁS","prefix":"1 de cada","value":3,"decimals":0,"label":"con dermatitis de contacto","sub":"Alergia en la piel tratada","image":staticFile('img/vn2_e07.png'),"mood":"warmdark"},
  /* b247 845s */ {},
  ...
  /* b254 865.1s */ {"theme":"white","title":"Furocumarinas","steps":["El aceite prensado en frío trae furocumarinas","Usted sale al sol: llega la luz ultravioleta","La furocumarina se activa"],"mood":"cool","nodes":[{"label":"Barrera"},{"label":"Ceramidas"},{"label":"Linoleico"},{"label":"Agua"}],"image":staticFile('img/vn2_fb_cool.png')},
  /* b255 869.9s */ {"theme":"white","title":"Se pega al ADN","steps":["Entra al núcleo de la célula","Se pega al ADN","La célula muere: quemadura química"],"mood":"cool","nodes":[{"label":"Barrera"},{"label":"Ceramidas"},{"label":"Linoleico"},{"label":"Agua"}],"image":staticFile('img/vn2_fb_cool.png')},
  /* b256 874.8s */ {},
  ...
  /* b259 882.4s */ {},
  /* b260 885.1s */ {"kicker":"ASOCIACIÓN DE FRAGANCIAS","value":0.4,"suffix":"%","decimals":1,"label":"es el tope permitido","sub":"Bergamota prensada en productos que quedan en la piel","image":staticFile('img/vn2_e13.png'),"mood":"science"},
  /* b261 889.6s */ {"mood":"gold","src":staticFile('broll/vn2vhn3n8eqs/vn2_e14.mp4'),"video":true,"ken":"out"},
  /* b262 894.5s */ {"kicker":"HAY REPORTES","value":0.03,"suffix":"%","decimals":2,"label":"ya dio fototoxicidad","sub":"Treinta veces menos que el tope","mood":"warmdark","image":staticFile('img/vn2_fb_warm.png')},
  /* b263 898.2s */ {},
  ...
  /* b273 931.9s */ {"kicker":"2021","value":5,"decimals":0,"label":"aceites medidos","sub":"En laboratorio y en piel humana","image":staticFile('img/vn2_e18.png'),"mood":"science"},
  /* b274 936s */ {},
  /* b275 939s */ {"kicker":"ACEITE DE COCO","prefix":"0 a","value":1.2,"decimals":1,"label":"de factor de protección","sub":"Eso es nada","image":staticFile('img/vn2_e19.png'),"mood":"warmdark"},
  /* b276 943.3s */ {},
  /* b277 945.7s */ {"kicker":"FACTOR 30","value":97,"suffix":"%","decimals":0,"label":"de la radiación bloqueada","sub":"Compare usted mismo","image":staticFile('img/vn2_e20.png'),"mood":"science"},
  /* b278 948.4s */ {},
  ...
  /* b288 981s */ {"kicker":"AUSTRALIA","value":903,"decimals":0,"label":"adultos seguidos","sub":"Durante años, en la vida real","image":staticFile('img/vn2_e26.png'),"mood":"science"},
  ...
  /* b294 999.8s */ {},
  /* b295 1002s */ {"kicker":"OTRO ENSAYO","value":87,"decimals":0,"label":"años de promedio","sub":"Doble ciego, y también mejoraron","image":staticFile('img/vn2_e30.png'),"mood":"gold"},
  /* b296 1004.5s */ {"kicker":"ENSAYO CLÍNICO","value":3,"suffix":" veces por semana","label":"Retinol","sub":"Mejoría medible en las arrugas finas","image":staticFile('img/vn2_f01.png'),"mood":"science"},
  /* b297 1008.2s */ {"kicker":"LOS PARTICIPANTES","value":87,"suffix":" años","label":"Edad promedio del grupo","sub":"Y la piel igual respondió","image":staticFile('img/vn2_f02.png'),"mood":"gold"},
  /* b298 1010.3s */ {},
  ...
  /* b303 1024.7s */ {"kicker":"ANHIDRO","value":0,"suffix":"%","label":"De agua en un aceite vegetal puro","sub":"Cero. No tiene agua para dar.","image":staticFile('img/vn2_f08.png'),"mood":"science"},
  ...
  /* b318 1072.9s */ {"kicker":"SI NO SE PONE NADA","value":91,"suffix":"%","label":"De la hidratación que tenía ANTES de bañarse","sub":"La ducha se lleva más de lo que deja","image":staticFile('img/vn2_f23.png'),"mood":"warmdark"},
  /* b319 1077.4s */ {},
  ...
  /* b331 1117s */ {"kicker":"DOSIS · CARA","prefix":"3 a ","value":5,"suffix":" gotas","label":"Para toda la cara","sub":"Nada más","image":staticFile('img/vn2_f36.png'),"mood":"gold"},
  /* b332 1119.1s */ {"kicker":"DOSIS · ANTEBRAZO","value":10,"suffix":" gotas","label":"Para un antebrazo entero","sub":"La dosis exacta del estudio de argán","image":staticFile('img/vn2_f37.png'),"mood":"science"},
  ...
  /* b338 1140.8s */ {"kicker":"PRUEBA DEL PARCHE","value":48,"suffix":" horas","label":"Antes de ponérselo en la cara","sub":"Una gota, una curita y esperar","image":staticFile('img/vn2_f43.png'),"mood":"science"},
  ...
  /* b353 1187.2s */ {"kicker":"FOTOENVEJECIMIENTO","value":80,"suffix":"%","label":"De lo que ve en el espejo se lo hizo el SOL","sub":"No el calendario","image":staticFile('img/vn2_f58.png'),"mood":"gold"},
  ...
  /* b367 1231.5s */ {"kicker":"EN USO DESDE","value":1872,"suffix":"","label":"Y sigue costando monedas","sub":"Está en cualquier farmacia, en el estante de abajo","image":staticFile('img/vn2_f72.png'),"mood":"warmdark"},
  /* b368 1234.5s */ {"kicker":"PÉRDIDA DE AGUA","value":99,"suffix":"%","label":"Menos pérdida de agua por la piel","sub":"Casi la corta del todo","image":staticFile('img/vn2_f73.png'),"mood":"science"},
  /* b369 1237.1s */ {},
  /* b370 1238.7s */ {"kicker":"LOS ACEITES DE HOY","value":30,"suffix":"%","label":"Ninguno de este video pasa de ahí","sub":"Y son los mejores que hay","image":staticFile('img/vn2_f75.png'),"mood":"cool"},
  /* b371 1241.5s */ {},
  /* b372 1244.5s */ {"src":staticFile('img/vn2_f77.png'),"video":false,"mood":"warmdark","ken":"in"},
  /* b373 1247.7s */ {"kicker":"ESTUDIO","value":1992,"suffix":"","label":"Lo demostró mirando la piel con microscopio","sub":"Poro por poro","image":staticFile('img/vn2_f78.png'),"mood":"science"},
  /* b374 1250.4s */ {},
