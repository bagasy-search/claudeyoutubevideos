// Main_mdslide.tsx — GENERADO. NO editar a mano.
import { AbsoluteFill, Audio, Sequence, staticFile } from "remotion";
import { CUES, OVERLAYS } from "./cues_mdslide.gen";

export const TOTAL_FRAMES_MDSLIDE = 37979;

export const MainMdSlide: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#0A0A0C" }}>
    ...
    <Audio src={staticFile("mdslide.m4a")} />
    {CUES.map((cue) => (
