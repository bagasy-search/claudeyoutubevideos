...
import { CUES, OVERLAYS } from "./cues_cme1.gen";
import { AVATAR_WINDOWS, TOTAL_CME1 } from "./avatar_cme1.gen";
export const TOTAL_FRAMES_CME1 = Math.round(TOTAL_CME1 * 30);
export const MainCme1: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: THEME_VOLT.color.bg0 }}>
    <CinematicWrap grain={0} vignette={0}>
      <AbsoluteFill style={{ backgroundColor: THEME_VOLT.color.bg0 }}>
        ...
        <AvatarLayer src="cme1_opt.mp4" windows={AVATAR_WINDOWS} accent="#C8F000" />
