// build_ohfflies.mjs — "Simple DIY trick to get rid of fruit flies in your kitchen" (The Old House Fix, EN).
//
//   node build_ohfflies.mjs
//
...
// El avatar es el PISO: real en los primeros 537 s (su propio lipsync) y en bucle mudo después,
...
//
// ⛔ TODO lo que dibuja video usa OffthreadVideo (copias locales en src/ohfflies/). Con <Video>
...
const SLUG = "ohfflies", COMP = "OhfFlies", FPS = 30;
...
const assets = [`${SLUG}_opt.mp4`, ...clipsUsed, ...fotosUsed, ...blurs, VIS].sort();
