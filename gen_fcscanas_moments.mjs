// gen_fcscanas_moments.mjs — parte el GUION en momentos y (si ya existe el mapa) los ANCLA al ms.
// Clon de gen_fcstaza9_moments.mjs. Video 100% Fish + avatar AvatarForever por ventanas.
//   node gen_fcscanas_moments.mjs   # sin _v3/fcscanas_wordms.json: momentos SIN ms · con él: + ms real
...
const ABRE = [
  ["Dime si esto te suena", "HOOK_ESPEJO"],
  ["Porque eso es lo otro. El ardor", "HOOK_ARDOR"],
  ["Bueno. Hoy te voy a enseñar una receta casera", "PROMESA"],
  ["Pero antes de seguir, te tengo que decir la verdad completa", "VERDAD"],
  ["Y hay dos cosas que te voy a guardar para el final", "RETENCION"],
  ["Déjame presentarme rapidito", "INTRO"],
  ["Ahora déjame contarte de alguien", "CASO_EUFEMIA"],
  ["Pero antes de darte la receta, tengo que explicarte", "MECANISMO_INTRO"],
  ["Cada pelo que tienes en la cabeza", "FOLICULO"],
  ["Ahora, ¿por qué se cansan los pintores?", "CAUSAS"],
  ["Adentro de la macetita", "CATALASA"],
  ["Y ya que estamos, déjame quitarte de la cabeza", "MITOS"],
  ["Entonces, a lo que iba", "PUEDE_NOPUEDE"],
  ["¿Y cómo pinta? Con dos cosas", "TANINOS"],
  ["Bueno. Ahora sí. Vamos con la receta", "RECETA_INTRO"],
  ["El primero: té negro", "ING_TE"],
  ["El segundo: café", "ING_CAFE"],
  ["El tercero: salvia", "ING_SALVIA"],
  ["Y el cuarto: el agua", "ING_AGUA"],
  ["Bueno, a preparar", "PREPARACION"],
  ["Ahora, antes de ponértelo, viene el paso", "PASO_SECRETO"],
  ["Bueno. A aplicar", "APLICACION"],
  ["¿Cuánto tiempo?", "TIEMPO"],
  ["Y ahora el sellado", "SELLADO"],
  ["¿Y cada cuánto?", "FRECUENCIA"],
  ["¿Cuándo se nota?", "CUANDO_SE_NOTA"],
  ["Ahora. No todos los pelos son iguales", "VARIANTES"],
  ["Ahora vamos a los errores", "ERRORES"],
  ["Y ahora sí. La prueba del mechón", "MECHON"],
  ["Bueno. Ahora tengo que cambiarme el sombrero", "MEDICO"],
  ["Y ahora, la comida", "COMIDA"],
  ["Y ahora. Lo que te guardé", "ADVERTENCIAS"],
  ["Dos. La henna negra", "HENNA"],
  ["Tres. La cáscara de nuez verde", "ADV_RESTO"],
  ["Bueno. Déjame juntarte todo", "RESUMEN"],
  ["Ahora, esta receta es una de muchas", "CTA"],
  ["Y ahora te pido un favor", "CIERRE"],
];
const secPorParrafo = [];
{
