...
const SECTIONS = [
  ...
  { key: "hook", phrase: null, start: 1.3, beats: [
    ...
    half("rv_pho_stall", "a steaming bowl of pho on a little plastic table at a street food stall in Vietnam", { kicker: "Everything — rent, food, the doctor", w: 0.55 }),
    r("rv_beach_aerial", "a long tropical city beach seen from above at golden hour, calm sea, Da Nang Vietnam", { w: 0.5, hold: true }),
    r("rv_n_market_morning", "a busy vietnamese morning street market, motorbikes and vendors, everyday life", { w: 0.45 }),
  ...
  { key: "catch", phrase: "one thing nobody puts", beats: [
    ...
    half("rv_calendar_x", "a wall calendar with days crossed off, worried mood, close and casual", { side: "left", kicker: "90 days flat", w: 0.9 }),
    rav("rv_him_serious", "sitting on a balcony looking straight at the camera, serious and honest, morning light", { w: 0.8, hold: true }),
  ]},
  ...
  { key: "angry", phrase: "Nobody tells us this", beats: [
    ...
    half("rv_market_fruit", "a colorful vietnamese street market piled with tropical fruit, vivid everyday life", { kicker: "A “not-enough” check", w: 0.9 }),
  ...
  { key: "kitchen", phrase: "Two years ago I was at a kitchen table", beats: [
    ...
    half("rv_thermostat", "a hand turning down an old house thermostat, worried, dim room", { side: "left", kicker: "Heat down to 62", w: 0.9 }),
    ...
    r("rv_old_hands_coffee", "an older man's tired hands wrapped around a coffee mug, morning, melancholy", { w: 0.8 }),
  ...
  { key: "nephew", phrase: "got a nephew good kid", beats: [
    ...
    half("rv_phone_photos", "an older man's hand holding a phone showing tropical beach photos, kitchen background", { side: "left", kicker: "“You're spending it in the wrong country”", w: 1.0 }),
    ...
    c("diorama", { src: "img/rv_plane_ticket.png", text: "“Buy *one* plane ticket. Come see.”", accent: GOLD, _genImg: "rv_plane_ticket", _prompt: P("a single round-trip paper plane ticket on a table, morning light, casual") }),
  ]},
  // ░░ 7 · ARRIVAL ░░
  { key: "arrival", phrase: "In January when Ohio", beats: [
    ...
    half("rv_him_beach_arrive", "standing on a tropical beach for the first time, sea breeze, quiet awe", { kicker: "In my head, I never came back", w: 1.0 }),
  ]},
  // ░░ 8 · DA NANG THE PLACE ░░
  { key: "danang", phrase: "where I actually live", beats: [
    r("rv_danang_beach_wide", "a wide clean tropical city beach with soft sand and calm warm water, morning, Da Nang", { hold: true, w: 1.1 }),
    r("rv_beach_walk", "an older western man walking barefoot on a quiet tropical beach at sunrise", { w: 0.7 }),
    r("rv_n_coast_road", "a scenic coastal road with palm trees curving along the sea in vietnam, sunny", { w: 0.6 }),
  ...
  { key: "apartment", phrase: "the apartment This is where", beats: [
    ...
    r("rv_apartment_interior", "a clean bright modern one-bedroom apartment with a small balcony, air conditioning, tidy", { hold: true, w: 1.1 }),
    half("rv_apartment_balcony", "a small apartment balcony with a city and sea view in vietnam, plants, morning", { kicker: "Furnished · 10-min walk to the sand", w: 1.0 }),
    r("rv_n_apartment_pool", "a rooftop pool and gym in a modern apartment tower in vietnam, sunny, expat living", { w: 0.5 }),
  ...
  { key: "food", phrase: "Food Oh the food", beats: [
    ...
    half("rv_him_eating", "happily eating a bowl of noodles at a street food stall in vietnam, candid", { side: "left", kicker: "I'd move here for the food alone", w: 0.9 }),
    ...
    r("rv_n_fruit_vendor", "a vietnamese woman selling piles of tropical fruit from a bicycle cart on a street, candid", { w: 0.5 }),
    r("rv_market_wonder", "a vietnamese wet market full of fresh fish fruit and vegetables, vivid, busy", { w: 0.6 }),
    c("callout", { image: "img/rv_market_wonder.png", figure: "$300", caption: "A whole month. Eating like a king.", accent: GOLD, eyebrow: "All my food", at: "Runs me right around" }),
  ]},
  // ░░ 11 · GETTING AROUND ░░
  { key: "around", phrase: "Everybody here rides a motorbike", beats: [
    ...
    r("rv_n_scooter_alley", "a river of scooters flowing through a narrow busy vietnamese street, everyday traffic", { w: 0.5 }),
    c("statpills", { pills: ["Scooter $50-60/mo", "Gas $2/week", "Ride across town $1-2"], accent: GOLD, at: "You can rent a decent scooter" }),
    kp("For getting around, it's *freedom*. About *$60-70* a month.", "rv_scooters_street", "an older man on a scooter smiling at a red light in vietnam, palm trees, sunny", { accent: GOLD, at: "call it $60" }),
  ]},
  ...
  { key: "utilities", phrase: "Utilities The electric bill", beats: [
    ...
    half("rv_relax_balcony", "an older western man relaxing with a book and coffee on a sunny balcony in vietnam", { kicker: "It gives an old man his time back", w: 1.0 }),
  ]},
  ...
  { key: "budget", phrase: "let me actually add it up", beats: [
    ...
    half("rv_him_content", "an older western man smiling content on a balcony at golden hour in vietnam", { side: "left", kicker: "Money to spare — first time since 40", w: 1.0 }),
  ]},
  ...
  { key: "health", phrase: "health care This is the one", beats: [
    ...
    r("rv_clinic_doctor", "an older western man talking with an english-speaking doctor in a bright modern clinic in vietnam", { w: 1.0, hold: true }),
    r("rv_n_hospital_ext", "a modern international hospital building in vietnam, clean, daytime", { w: 0.5 }),
    ...
    half("rv_him_hospital", "an older western man sitting on a hospital observation bed looking relieved, clean modern room", { side: "left", kicker: "The whole night — a few hundred dollars", w: 0.9 }),
    kp("*No letter in the mail* that ruins your Tuesday.", "rv_mailbox", "an empty american mailbox, conceptual relief, soft light", { accent: GREEN, at: "No letter in the mail" }),
  ...
  { key: "visa", phrase: "the trap door the visa", beats: [
    ...
    c("diorama", { src: "img/rv_passport_stamp.png", text: "Vietnam has *no retirement visa*.", accent: ALARM, tint: "#2A0A08", _genImg: "rv_passport_stamp", _prompt: P("a US passport and a vietnam visa page on a desk, official, close") }),
    ...
    half("rv_agent_desk", "an older western man at a small visa agency desk handing over papers, helpful staff", { side: "left", kicker: "Use a local agent — stay legal", w: 0.9 }),
  ...
  { key: "firstweeks", phrase: "how you do this step by step", beats: [
    ...
    half("rv_feet_sand", "an older man's bare feet in warm tropical sand at the water's edge, casual", { kicker: "At the end of two weeks, your body will know", w: 1.0 }),
    kp("One ticket and a month's rent to find your life just got *bigger*.", "rv_horizon", "an older western man looking out at a bright tropical sea horizon, hopeful, wide", { accent: GOLD, at: "just got a whole lot bigger" }),
  ]},
  ...
  { key: "distance", phrase: "The distance My grandkids", beats: [
    half("rv_videocall", "an older western man on a video call with grandkids on a laptop, bittersweet, evening", { side: "left", kicker: "My grandkids — the other side of the world", w: 1.0 }),
    r("rv_photos_wall", "framed family photos of grandkids on an apartment wall in vietnam, tender", { w: 0.7 }),
    kp("A video call is a gift. But it's not the same as *holding them*.", "rv_n_hug_photo", "an older man hugging young grandchildren in a warm family photo, tender", { accent: BLUE, at: "not the same as holding them" }),
    ...
    kp("This life is cheaper. It is *not free*. You pay some in *miles*.", "rv_plane_sky", "a plane crossing a wide sky over the ocean, longing, warm light", { accent: BLUE, at: "you pay some of it in" }),
  ]},
  ...
  { key: "close", phrase: "leave you with a picture", beats: [
    r("rv_morning_beach_ladies", "elderly vietnamese women doing morning exercises and laughing on a tropical beach at sunrise", { hold: true, w: 1.1 }),
    half("rv_him_morning", "an older western man standing with feet in the warm sea at sunrise, peaceful, coffee in hand", { kicker: "Feet in the sea, warm as a bath", w: 1.0 }),
    r("rv_n_sunrise_sea", "a calm tropical sunrise over the sea with soft golden light, serene, wide", { w: 0.7 }),
    kp("Grilled fish tonight — *six dollars* — and we'll close the place down talking.", "rv_river_dinner", "a warm evening riverside grilled fish dinner under a lit bridge in vietnam, friends", { accent: GOLD, at: "cost us six dollars each" }),
    kpav("Buddy — it *wasn't over*. You were doing the math in the *wrong country*.", "rv_him_close", "an older western man looking warmly at the camera at golden hour on a balcony in vietnam", { accent: GOLD, fontSize: 108, at: "it wasn't over" }),
  ...
  { key: "cta", phrase: "wrote all of it out", beats: [
    half("rv_him_guide", "an older western man holding up a simple printed guide booklet, friendly, at a cafe", { side: "left", kicker: "I wrote all of it out — free", w: 1.0 }),
    ...
    c("diorama", { src: "img/rv_ticket_sunset.png", text: "A check that becomes a *first-class ticket*.", accent: GOLD, _genImg: "rv_ticket_sunset", _prompt: P("a plane ticket on a table with a tropical sunset behind, hopeful, warm") }),
...
for (let si = 0; si < SECTIONS.length; si++) {
  ...
  real.forEach((b, i) => {
    ...
    if (b.t === "raw") {
      ...
      delete beat.at; delete beat.w; delete beat.name; delete beat._genImg; delete beat._prompt;
