// build_nrvaseneck.mjs — clon de build_nrg-oil (cadena fcsmanos10) + tipo "lamina" (LaminaZoom con zoom a regiones y CTA portada+QR). Lee _v3/nrvaseneck_plan.json y emite
...
const SLUG = "nrvaseneck", COMP = "Nrvaseneck", UP = "NRVASENECK", FPS = 30;
const COVER = "img/nrvaseneck_cover.jpg", QR = "qr_nrvaseneck.png", SITE = "docfederer.com/firm-skin";
...
if (sinCama.length) {
  ...
  console.error("   → corré: node scripts/gen_beds.mjs nrvaseneck");
  process.exit(1);
}
