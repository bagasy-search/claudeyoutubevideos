// build_fabolsasojos.mjs — MONTAJE del video `fabolsasojos` (plan → cues + Main + index + assets list).
...
const SLUG = "fabolsasojos", COMP = "Fabolsasojos", UP = "FABOLSASOJOS", FPS = 30;
...
// ── COMPUERTA: cobertura 100 % + avatar cada ≤30 s + apertura con avatar
{
  ...
  if (peor / FPS > 50) { console.error("⛔ hay más de 50 s sin avatar"); process.exit(1); }   // reel único ya generado: máx medido 46 s
}
