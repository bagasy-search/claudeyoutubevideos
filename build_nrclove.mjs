// build_nrclove.mjs — clon de build_nrg-oil (cadena fcsmanos10) + tipo "lamina" (LaminaZoom con zoom a regiones y CTA portada+QR). Lee _v3/nrclove_plan.json y emite
//   src/_fed6/VideoEdit/Main_nrclove.tsx      (build real, con `startSec:` por cue → lo mide el gate)
//   src/_fed6/VideoEdit/avatar_nrclove.gen.ts (ventanas de avatar → tiempo VISIBLE del gate)
//   src/index_nrclove.tsx
...
const SLUG = "nrclove", COMP = "Nrclove", UP = "NRCLOVE", FPS = 30;
const COVER = "img/nrclove_cover.jpg", QR = "qr_nrclove.png", SITE = "docfederer.com/after-60";
...
if (sinCama.length) {
  ...
  console.error("   → corré: node scripts/gen_beds.mjs nrclove");
  process.exit(1);
}
