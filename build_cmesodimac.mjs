...
//  ⛔⛔ EL AVATAR VA CON OffthreadVideo, NUNCA CON <Video>. En el RENDER, <Video> usa un elemento
//     HTML que busca por tiempo y no acierta el cuadro exacto: repite y saltea cuadros de forma
//     IRREGULAR y se ve como TIRON. Se nota justo donde el avatar queda a la vista sin nada
//     encima. Esto ya se habia arreglado A MANO en los Main de cmeenchufe y cmegenerador, pero
//     NUNCA en el generador — asi que cada video nuevo que clonaba el build se traia el bug.
