# -*- coding: utf-8 -*-
"""QR del embudo de fcshigado -> public/img/qr_apafireants.png
qrcode ECC-M, quiet-zone 4 modulos, verificacion por decode con OpenCV a 360/420/560px
(⛔ cv2 no decodifica un PNG gigante con modulos enormes: hay que verificar REDIMENSIONADO,
que es como se ve en pantalla)."""
...
URL = "https://pest-free-garden-blueprint.vercel.app"
...
def main() -> None:
    ...
    for px in (360, 420, 560):
        ...
        assert dec == URL, f"fcshigado_qr no decodifica a {px}px: {dec!r}"
