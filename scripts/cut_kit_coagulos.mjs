// cut_kit_coagulos.mjs — corta un CLIP corto del avatar por cada beat avatarkeyword/avatarpizarra
// (lee public/avatar_clips_coagulos.json = KIT_CLIPS {name,start,dur}) → public/avatar_clips/coagulos/<name>.mp4
