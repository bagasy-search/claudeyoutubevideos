...
const SYSTEM = `Mirás UN cuadro de un video y contestás UNA sola pregunta objetiva:
¿HAY UNA PERSONA VISIBLE en la imagen?
Cuenta como persona: una cara, un torso, un cuerpo entero, alguien de espaldas o de perfil, alguien al fondo o reflejado en un espejo.
NO cuenta como persona: sólo manos o sólo dedos sin que se vea el cuerpo ni la cara; una foto o un cuadro colgado en la pared; un maniquí.
Devolvé SOLO JSON: {"ok": true|false, "issue": "sin-persona"|"hay-persona", "reason": "<6-12 palabras: quién y dónde>"}.
ok=true significa que NO hay ninguna persona visible. ok=false significa que SÍ hay una persona.`;
