# -*- coding: utf-8 -*-
"""QR funcional del embudo de raybar1 -> public/img/raybar1_qrcard.png
...
def main() -> None:
    ...
    for px in (360, 420, 560):
        ...
        assert dec == URL, f"raybar1_qrcard no decodifica a {px}px: {dec!r}"
