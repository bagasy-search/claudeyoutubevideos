...
const SLUG = process.argv[2] || "dale7";
...
const CORTES = [
  ...
  ["MANANA",  /^Six in the morning\. Number one/],
  ["MEDIA",   /^Ten in the morning/],
  ["TARDE",   /^One in the afternoon/],
  ["NOCHE",   /^Six in the evening/],
  ["ULTIMA",  /^Nine at night/],
  ["CIERRE",  /^That is the day/],
];
let sec = "HOOK";
let k = 0;
for (const m of mom) {
