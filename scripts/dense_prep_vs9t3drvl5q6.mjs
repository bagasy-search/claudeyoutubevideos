// dense_prep_vs9t3drvl5q6.mjs — toma public/broll/dense_vs9t3drvl5q6.json ({at,query}) →
// resuelve cada 'at' al ms del caption, afina a ~2.3s, asigna nombres POR-SLUG (anti-colisión) y escribe:
//   public/broll/dense_thinned_vs9t3drvl5q6.json
//   public/broll/shots_dense_vs9t3drvl5q6.json  (para fetchstock)
//   src/_fed6/VideoEdit/federer_vs9t3drvl5q6_broll.ts  (FEDZ_BROLL, track contiguo)
import fs from "fs";
