// broll_finalize_vgv2q0an50ik.mjs — tras fetchstock: valida cada clip (existe, >8KB, ffprobe OK),
// re-encoda los válidos a 720p mudo (tarball liviano) y REESCRIBE federer_vgv2q0an50ik_broll.ts
