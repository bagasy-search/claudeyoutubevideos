# -*- coding: utf-8 -*-
"""QR funcional del embudo de mdboots -> public/img/rkbottle_qrcard.png
...
def main() -> None:
    ...
    for px in (360, 420, 560):
        ...
        assert dec == URL, f"rkbottle_qrcard no decodifica a {px}px: {dec!r}"
