// Anclaje frase->frame para #16, usando _bastidarenal16_wordms.json (palabras del guion + ms).
import fs from 'fs';
const FPS = 30;
const wm = JSON.parse(fs.readFileSync('_bastidarenal16_wordms.json', 'utf8'));
