# -*- coding: utf-8 -*-
"""QR funcional del embudo de mdboots -> public/img/mdplumb_qrcard.png
...
def main() -> None:
    ...
    for px in (360, 420, 560):
        ...
        assert dec == URL, f"mdplumb_qrcard no decodifica a {px}px: {dec!r}"
