// wordms_dale7.mjs — alinea canales/dale7_GUION.txt contra public/captions_dale7.json (Fish ASR)
// y emite _v3/dale7_wordms.json = [{w, off, t}] con el ms exacto de cada palabra DEL GUION.
//
...
//
//   node scripts/wordms_dale7.mjs [slug]
