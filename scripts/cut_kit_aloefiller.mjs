// cut_kit_aloefiller.mjs — corta un CLIP corto del avatar por cada beat avatarkeyword/avatarpizarra
// (lee public/avatar_clips_aloefiller.json = KIT_CLIPS {name,start,dur}) → public/avatar_clips/aloefiller/<name>.mp4
// desde el frame 0 (fast-decode, MUTED). Evita el deep-seek que da avatar negro en el farm.
import fs from "fs";
import { execFileSync } from "child_process";
const SLUG = "aloefiller";
