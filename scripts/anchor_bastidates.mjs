 ...
 * Lee public/bastidates_guion.txt + public/captions_bastidates.json.
 * Resuelve el FRAME (30fps) de cada frase-ancla y escribe _v3/bastidates_anchors.json.
 */
import fs from 'fs';
...
const guion = fs.readFileSync('public/bastidates_guion.txt', 'utf8');
const caps = JSON.parse(fs.readFileSync('public/captions_bastidates.json', 'utf8'));
...
const anchors = JSON.parse(fs.readFileSync(process.argv[2] || 'scripts/bastidates_anchor_phrases.json', 'utf8'));
const out = {};
let miss = 0;
...
fs.writeFileSync('_v3/bastidates_anchors.json', JSON.stringify(out, null, 2));
