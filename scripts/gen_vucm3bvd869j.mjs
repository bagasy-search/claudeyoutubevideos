...
anc("hay un error que cometen 9 de cada 10", 6.2, (d) => `<FedStat totalF={${F(d)}} kicker="El error del final" value={9} suffix=" de cada 10" label="lo están haciendo" sub="Se compra sin receta. Te lo cuento al final." accent={ACC} mood="warmdark" />`);
...
anc("dolor o ardor que aparece caminando", 6.0, (d) => `<FedStat totalF={${F(d)}} kicker="Enfermedad arterial periférica" value={3} suffix=" cuadras" label="siempre la misma distancia" sub="Camina, arde, para, se va. Como un reloj." accent={ACC} mood="warmdark" />`);
...
anc("muestran bajas de alrededor de 8 milimetros", 7.0, (d) => `<FedStat totalF={${F(d)}} kicker="Revisiones en personas con presión alta" value={8} prefix="−" suffix=" mmHg" label="en la máxima" sub="Y unos 5 en la mínima. Para una cabeza de ajo, es un montón." accent={ACC} mood="gold" />`);
...
anc("el frasco que compraste para el hormigueo", 6.0, (d) => `<FedStat totalF={${F(d)}} kicker="Descrito hace más de 40 años" value={40} suffix=" años" label="en la literatura médica" sub="Por eso las agencias limitan las dosis de venta libre." accent={ALERT} mood="warmdark" />`);
