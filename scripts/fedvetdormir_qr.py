# -*- coding: utf-8 -*-
"""QR del embudo de fedvetdormir -> public/med/fedvetdormir_qr.png
...
URL = "https://drfederer.com/veterinario"
...
def main() -> None:
    ...
    for px in (360, 420, 560):
        ...
        assert dec == URL, f"fedvetdormir_qr no decodifica a {px}px: {dec!r}"
