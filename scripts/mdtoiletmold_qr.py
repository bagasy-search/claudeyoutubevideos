# -*- coding: utf-8 -*-
"""QR funcional del embudo de mdboots -> public/img/mdtoiletmold_qrcard.png
...
def main() -> None:
    ...
    qr_img = build_qr()
    path = OUT / "mdtoiletmold_qrcard.png"
    ...
    for px in (360, 420, 560):
        ...
        assert dec == URL, f"mdtoiletmold_qrcard no decodifica a {px}px: {dec!r}"
