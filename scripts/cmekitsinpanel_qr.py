# -*- coding: utf-8 -*-
"""QR del embudo de cmekitsinpanel -> public/img/cmekitsinpanel/cmek_qr.png

Va en public/img/<slug>/ a proposito: el scanProps del build empaqueta img/ y broll/,
y un QR en med/ ya dejo 5 chunks muertos por 404 en fedvet7.

qrcode ECC-M, quiet-zone 4 modulos, verificacion por decode con OpenCV a 360/420/560 px
(sobre el PNG gigante cv2 devuelve vacio aunque el codigo este perfecto).
"""
...
OUT = ROOT / "public" / "img" / "cmekitsinpanel"
...
def main() -> None:
    ...
    for px in (360, 420, 560):
        ...
        assert dec == URL, f"cmek_qr no decodifica a {px}px: {dec!r}"
