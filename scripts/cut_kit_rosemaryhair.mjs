// cut_kit_rosemaryhair.mjs — corta un CLIP corto del avatar por cada beat avatarkeyword/avatarpizarra
// (lee public/avatar_clips_rosemaryhair.json = KIT_CLIPS {name,start,dur}) → public/avatar_clips/rosemaryhair/<name>.mp4
// desde el frame 0 (fast-decode, MUTED). Evita el deep-seek que da avatar negro en el farm.
import fs from "fs";
import { execFileSync } from "child_process";
const SLUG = "rosemaryhair";
