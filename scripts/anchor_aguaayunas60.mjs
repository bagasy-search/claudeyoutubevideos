/**
 * anchor_quesos.mjs — alineación GLOBAL guion↔ASR (SequenceMatcher-style) para el video aguaayunas60.
 * Lee public/aguaayunas60_guion.txt + public/captions_aguaayunas60.json.
 * Resuelve el FRAME (30fps) de cada frase-ancla y escribe _v3/aguaayunas60_anchors.json.
 */
import fs from 'fs';
...
const guion = fs.readFileSync('public/aguaayunas60_guion.txt', 'utf8');
const caps = JSON.parse(fs.readFileSync('public/captions_aguaayunas60.json', 'utf8'));
...
fs.writeFileSync('_v3/aguaayunas60_anchors.json', JSON.stringify(out, null, 2));
