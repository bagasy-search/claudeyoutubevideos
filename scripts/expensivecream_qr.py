# -*- coding: utf-8 -*-
"""QR del embudo de expensivecream -> public/med/expensivecream_qr.png
...
def main() -> None:
    ...
    qr_img = build_qr()
    path = OUT / "expensivecream_qr.png"
    ...
    for px in (360, 420, 560):
        ...
        assert dec == URL, f"expensivecream_qr no decodifica a {px}px: {dec!r}"
