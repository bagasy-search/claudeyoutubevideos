# -*- coding: utf-8 -*-
"""QR del embudo de faarroz -> public/med/faarroz_qr.png
qrcode ECC-M, quiet-zone 4 modulos (la zona de silencio es lo que lo hace decodificable en pantalla),
verificacion por decode con pyzbar (primario) y OpenCV (respaldo) a 360/420/560 px."""
...
URL = "https://drfederer.com/firmeza?src=yt"
...
def main() -> None:
    ...
    for px in (360, 420, 560):
        ...
        assert dec == URL, f"faarroz_qr no decodifica a {px}px: {dec!r}"
