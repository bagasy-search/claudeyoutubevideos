// cut_kit_rosemarymask.mjs — corta un CLIP corto del avatar por cada beat avatarkeyword/avatarpizarra
// (lee public/avatar_clips_rosemarymask.json = KIT_CLIPS {name,start,dur}) → public/avatar_clips/rosemarymask/<name>.mp4
// desde el frame 0 (fast-decode, MUTED). Evita el deep-seek que da avatar negro en el farm.
import fs from "fs";
import { execFileSync } from "child_process";
const SLUG = "rosemarymask";
