...
guion = open("canales/bastida_16_senales_SINTAGS.txt", encoding="utf-8").read()
caps = json.load(open("public/captions_bastidarenal16_full.json", encoding="utf-8"))
GW = words(guion)
...
json.dump({"words":GW,"ms":ms}, open("_bastidarenal16_wordms.json","w",encoding="utf-8"), ensure_ascii=False)
