# -*- coding: utf-8 -*-
"""QR del embudo de favaselina -> public/med/fedvetdolor_qr.png
...
URL = "https://drfederer.com/veterinario?src=yt"
...
def main() -> None:
    ...
    for px in (360, 420, 560):
        ...
        assert dec == URL, f"fedvetdolor_qr no decodifica a {px}px: {dec!r}"
