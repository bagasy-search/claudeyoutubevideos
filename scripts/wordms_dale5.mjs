// wordms_dale5.mjs — alinea canales/dale5_GUION.txt contra public/captions_dale5.json (Fish ASR)
// y emite _v3/dale5_wordms.json = [{w, off, t}] con el ms exacto de cada palabra DEL GUION.
//
...
//
//   node scripts/wordms_dale5.mjs [slug]
