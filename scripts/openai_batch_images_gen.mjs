// openai_batch_images_gen.mjs — GEMELO de openai_batch_images.mjs para los planos SIN presentador.
//   Unica diferencia: endpoint /v1/images/generations (sin imagen de referencia).
//   El endpoint del batch tiene que coincidir con el `url` de TODAS las filas, por eso hacen
//   falta DOS batches: uno de /edits (presentador + ref de cara) y este de /generations.
...
//    mezclar /v1/images/edits con /v1/images/generations en el mismo batch.
