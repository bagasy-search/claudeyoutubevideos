// cut_kit_handsage.mjs — corta un CLIP corto del avatar por cada beat avatarkeyword/avatarpizarra
// (lee public/avatar_clips_handsage.json = KIT_CLIPS {name,start,dur}) → public/avatar_clips/handsage/<name>.mp4
