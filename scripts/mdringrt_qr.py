# -*- coding: utf-8 -*-
"""QR funcional del embudo de mdringrt -> public/img/mdringrt_qrcard.png
...
def main() -> None:
    ...
    for px in (360, 420, 560):
        ...
        assert dec == URL, f"mdringrt_qrcard no decodifica a {px}px: {dec!r}"
