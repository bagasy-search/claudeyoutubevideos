// gen_falifting_moments.mjs — parte el GUION en momentos y (si ya existe el mapa) los ANCLA al ms.
...
const ABRE = [
  ["Pon las dos manos así", "HOOK"],
  ["Así que aquí va la rutina completa.", "RUTINA"],
  ["Ya está. Esa es la rutina entera.", "LOOPS"],
  ["Déjame presentarme rapidito", "INTRO"],
  ["Ahora, déjame contarte de alguien.", "MARTA"],
  ["Mira. Debajo de la piel", "MUSCULOS"],
  ["¿Hay estudios?", "EVIDENCIA"],
  ["Bueno. Ahora sí, vamos uno por uno.", "E1"],
  ["Dos. Los ojos.", "E2"],
  ["Tres. Las mejillas.", "E3"],
  ["Cuatro. La boca.", "E4"],
  ["Y ahora te quiero enseñar algo.", "LAMINA"],
  ["Y dicho sea de paso", "GUIA"],
  ["Bueno. Nos faltan tres.", "E5"],
  ["Seis. El cuello.", "E6"],
  ["Y siete. El cierre.", "E7"],
  ["Bueno. Te prometí volver", "MARTA2"],
  ["Ahora, te quiero decir algo con total honestidad.", "SUMA"],
  ["Y ahora, lo que no puedo dejar de decirte.", "SEGURIDAD"],
